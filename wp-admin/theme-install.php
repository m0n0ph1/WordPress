    ...
    <div class="wrap">
        ...
        <div class="wp-filter hide-if-no-js">
            ...
            <button type="button"
                    ...
                    aria-expanded="false"><?php _e('Feature Filter'); ?></button>
            ...
            <div class="favorites-form">
                ...
                <p>
                    ...
                    <input type="button"
                           class="button favorites-form-submit"
                           value="<?php esc_attr_e('Get Favorites'); ?>"/>
                </p>
            </div>

            <div class="filter-drawer">
                <div class="buttons">
                    <button type="button" class="apply-filters button"><?php _e('Apply Filters'); ?><span></span>
                    </button>
                    <button type="button"
                            class="clear-filters button"
                            aria-label="<?php esc_attr_e('Clear current filters'); ?>"><?php _e('Clear'); ?></button>
                </div>
                <?php
        ...
        <div class="theme-id-container">
            ...
            <div class="theme-actions">
                ...
                <a class="button button-primary theme-install"
                   ...
                   aria-label="<?php echo esc_attr($aria_label); ?>"><?php _e('Install'); ?></a>
                <button class="button preview install-theme-preview"><?php _e('Preview'); ?></button>
                <# } else { #>
                <?php
                    /* translators: %s: Theme name. */
                ...
                <a class="button button-primary disabled"
                   data-name="{{ data.name }}"
                   aria-label="<?php echo esc_attr($aria_label); ?>"><?php _ex('Cannot Install', 'theme'); ?></a>
                <button class="button disabled"><?php _e('Preview'); ?></button>
                <# } #>
                <# } #>
            </div>
        ...
        <div class="wp-full-overlay-sidebar">
            <div class="wp-full-overlay-header">
                ...
                <a href="{{ data.install_url }}"
                   ...
                   data-name="{{ data.name }}"
                   data-slug="{{ data.id }}"><?php _e('Install'); ?></a>
                <# } else { #>
