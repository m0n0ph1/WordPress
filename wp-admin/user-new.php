...
%4$s'
        ...
        if (!is_multisite()) {
            ...
            if (is_wp_error($user_details['errors']) && $user_details['errors']->has_errors()) {
                ...
                $new_user_login = apply_filters('pre_user_login',
        ...
        if (is_multisite()) {
            ...
            switch ($_GET['update']) {
                ...
                case 'created_could_not_add':
                    $add_user_errors = new WP_Error('created_could_not_add',
                        __('User has been created, but could not be added to this site.'));
                    break;
                case 'does_not_exist':
