...
// Flag that we're loading the block editor.
    ...
    $editor_settings = get_block_editor_settings(array_merge(get_legacy_widget_block_editor_settings(), ['styles' => get_block_editor_theme_styles()]), $block_editor_context);
