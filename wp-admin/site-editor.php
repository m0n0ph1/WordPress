...
// Add additional back-compat patterns registered by `current_screen` et al.
    ...
    $navigation_rest_route = rest_get_route_for_post_type_items('wp_navigation');
...
// Preload server-registered block schemas.
    ...
    wp_add_inline_script('wp-blocks', sprintf('wp.blocks.setCategories( %s );', wp_json_encode(isset($editor_settings['blockCategories']) ? $editor_settings['blockCategories'] : [])), 'after');
