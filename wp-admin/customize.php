    ...
    <form id="customize-controls" class="wrap wp-full-overlay-sidebar">
            ...
            <?php else : ?>
                ...
                <div id="customize-save-button-wrapper" class="customize-save-button-wrapper disabled">
                    <button class="button button-primary disabled"
                            aria-label="<?php esc_attr_e('Publish Settings'); ?>"
                            aria-expanded="false"
                            disabled><?php echo $save_text; ?></button>
                </div>
            <?php endif; ?>
        ...
        <div id="widgets-right" class="wp-clearfix">
            ...
            <div class="wp-full-overlay-sidebar-content" tabindex="-1">
                <div id="customize-info"
                     class="accordion-section customize-info"
                     data-block-theme="<?php echo (int) wp_is_block_theme(); ?>">
                    <div class="accordion-section-title">
						<span class="preview-notice">
						<?php
                            /* translators: %s: The site/panel title in the Customizer. */
                            printf(__('You are customizing %s'),
                                '<strong class="panel-title site-title">' . get_bloginfo('name',
                                    'display') . '</strong>');
                        ?>
						</span>
                        <button type="button"
        ...
        <div id="customize-footer-actions" class="wp-full-overlay-footer">
            <button type="button"
                    ...
                    aria-expanded="true"
                    aria-label="<?php echo esc_attr_x('Hide Controls',
                    ...
                    <div class="devices">
                        <?php foreach ((array) $previewable_devices as $device => $settings) : ?>
                            ...
                            <button type="button"
                                    ...
                                    aria-pressed="<?php echo esc_attr($active); ?>"
