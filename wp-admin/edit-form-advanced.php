<?php
    ...
    $messages['post'] = [
        ...
        9 => sprintf(__('Post scheduled for: %s.'),
                '<strong>' . $scheduled_date . '</strong>') . $scheduled_post_link_html,
    ...
    $messages['page'] = [
        ...
        9 => sprintf(__('Page scheduled for: %s.'),
                '<strong>' . $scheduled_date . '</strong>') . $scheduled_page_link_html,
                                        ...
                                        <td class="autosave-info">
                                            ...
                                            <?php
                                                if ('auto-draft' !== $post->post_status) {
                                                    ...
                                                    $last_user = get_userdata(get_post_meta($post->ID, '_edit_last',
                                                        true));
                                                    if ($last_user) {
