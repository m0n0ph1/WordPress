...
?>
    ...
    <div class="wrap">
        ...
        <?php
            wp_admin_notice('<strong>'.__('Warning:').'</strong> '.__('This page allows direct access to your site settings. You can break things here. Please be cautious!'), [
                'type' => 'warning',
            ]);
        ?>
                    ...
                    foreach((array) $options as $option) :
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else : ?>
                                    <input class="regular-text <?php echo $class; ?>"
                                           type="text"
                                           name="<?php echo $name; ?>"
                                           id="<?php echo $name; ?>"
