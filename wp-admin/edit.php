...
// Used in the HTML title tag.
    ...
    $bulk_messages['post'] = [
        ...
        'locked' => (1 === $bulk_counts['locked']) ? __('1 post not updated, somebody is editing it.') : /* translators: %s: Number of posts. */
    ...
    $bulk_messages['page'] = [
        ...
        'locked' => (1 === $bulk_counts['locked']) ? __('1 page not updated, somebody is editing it.') : /* translators: %s: Number of pages. */
    ...
    $bulk_messages['wp_block'] = [
        ...
        'locked' => (1 === $bulk_counts['locked']) ? __('1 block not updated, somebody is editing it.') : /* translators: %s: Number of blocks. */
