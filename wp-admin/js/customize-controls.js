...
(function (exports, $) {
    ...
    api.ThemesPanel = api.Panel.extend(/** @lends wp.customize.ThemsPanel.prototype */{
        ...
        installTheme: function (event) {
            var panel = this, preview, onInstallSuccess, slug = $(event.target).data('slug'), deferred = $.Deferred(),
                request;
    ...
    api.Previewer = api.Messenger.extend(/** @lends wp.customize.Previewer.prototype */{
        ...
        login: function () {
            ...
            iframe = $('<iframe />', {
                'src': api.settings.url.login,
                'title': api.l10n.loginIframeTitle
    ...
    $(function () {
        ...
        api.section('publish_settings', function (section) {
            var updateButtonsState, trashControl, updateSectionActive, isSectionActive, statusControl, dateControl,
                toggleDateControl, publishWhenTime, pollInterval, updateTimeArrivedPoller, cancelScheduleButtonReminder,
