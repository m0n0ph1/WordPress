    ...
    <div class="wrap">
        ...
        <?php
            ...
            if ($message) {
                ...
                if ($wp_http_referer) {
                    $message .= '<p><a href="' . esc_url(wp_validate_redirect(sanitize_url($wp_http_referer),
                            admin_url('term.php?taxonomy=' . $taxonomy))) . '">' . esc_html($tax->labels->back_to_items) . '</a></p>';
                }
                wp_admin_notice(
                    $message,
                    [
        ...
        >
            ...
            <table class="form-table" role="presentation">
                <tr class="form-field form-required term-name-wrap">
                    ...
                    <td><input name="name"
                               id="name"
                               type="text"
                               value="<?php echo $tag_name_value; ?>"
                               size="40"
                               aria-required="true"
                               aria-describedby="name-description"/>
                        <p class="description"
                           id="name-description"><?php echo $tax->labels->name_field_description; ?></p></td>
                </tr>
                <tr class="form-field term-slug-wrap">
                    ...
                    <td><input name="slug"
                        ...
                        <p class="description"
                           id="slug-description"><?php echo $tax->labels->slug_field_description; ?></p></td>
                </tr>
                    ...
                    <tr class="form-field term-parent-wrap">
                        ...
                        <td>
                            ...
                            <?php if ('category' === $taxonomy) : ?>
                                <p class="description"
                                   id="parent-description"><?php _e('Categories, unlike tags, can have a hierarchy. You might have a Jazz category, and under that have children categories for Bebop and Big Band. Totally optional.'); ?></p>
                            <?php else : ?>
                                <p class="description"
                                   id="parent-description"><?php echo $tax->labels->parent_field_description; ?></p>
                            <?php endif; ?>
                        </td>
                    </tr>
                ...
                <tr class="form-field term-description-wrap">
                    ...
                    <td><textarea name="description"
                                  ...
                                  cols="50"
                                  class="large-text"
                                  aria-describedby="description-description"><?php echo $tag->description; // textarea_escaped ?></textarea>
                        <p class="description"
                           id="description-description"><?php echo $tax->labels->desc_field_description; ?></p></td>
                </tr>
                <?php
                    // Back compat hooks.
                    if ('category' === $taxonomy) {
                         ...
                         * @since 2.9.0
                         */
                        do_action_deprecated('edit_category_form_fields', [$tag], '3.0.0',
                         ...
                         * @since 2.9.0
                         */
                        do_action_deprecated('edit_link_category_form_fields', [$tag], '3.0.0',
                            '{$taxonomy}_edit_form_fields');
                    } else {
                        /**
            ...
            <div class="edit-tag-actions">
                ...
                <?php if (current_user_can('delete_term', $tag->term_id)) : ?>
                    <span id="delete-link">
			<a class="delete"
               href="<?php echo esc_url(admin_url(wp_nonce_url("edit-tags.php?action=delete&taxonomy=$taxonomy&tag_ID=$tag->term_id",
