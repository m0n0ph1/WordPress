    ...
    switch ($action) {
        ...
        case 'move-down-menu-item':
            ...
            if (is_nav_menu_item($menu_item_id)) {
                $menus = isset($_REQUEST['menu']) ? [(int) $_REQUEST['menu']] : wp_get_object_terms($menu_item_id,
                    'nav_menu', ['fields' => 'ids']);
                    ...
                    if (isset($orders_to_dbids[$dbids_to_orders[$menu_item_id] + 1])) {
                        ...
                        if (!empty($menu_item_data['menu_item_parent'])
                            ...
                            if (!is_wp_error($parent_object)) {
                                ...
                                update_post_meta($menu_item_data['ID'], '_menu_item_menu_item_parent',
                                    (int) $menu_item_data['menu_item_parent']);
                            }
                        ...
                        $menu_item_data['menu_item_parent'] = (int) get_post_meta($menu_item_data['menu_item_parent'],
                            '_menu_item_menu_item_parent', true);
                            ...
                            if (!is_wp_error($parent_object)) {
                                ...
                                if (!empty($dbids_to_orders[$parent_db_id])
                                    ...
                                    */
                                    ...
                                    $_possible_parent_id = (int) get_post_meta($orders_to_dbids[$dbids_to_orders[$parent_db_id] - 1],
                                        '_menu_item_menu_item_parent', true);
        ...
        case 'update':
            ...
            if (0 === $nav_menu_selected_id) {
                ...
                if (!is_wp_error($_menu_object)) {
                    $_nav_menu_selected_id = wp_update_nav_menu_object($nav_menu_selected_id,
                ...
                if (!is_wp_error($_menu_object)) {
                    $messages = array_merge($messages,
                        wp_nav_menu_update_menu_items($_nav_menu_selected_id, $nav_menu_selected_title));
            ...
            printf(
                ...
                esc_url(
                    add_query_arg(
                        [
                            ['autofocus' => $focus],
                            'return' => urlencode(remove_query_arg(wp_removable_query_args(),
    ...
    <?php
        if ($locations_screen) :
            ...
            <div id="menu-locations-wrap">
                <form method="post"
                      action="<?php echo esc_url(add_query_arg(['action' => 'locations'],
                            ...
                            <tr class="menu-locations-row">
                                ...
                                <td class="menu-location-menus">
                                    <select name="menu-locations[<?php echo $_location; ?>]"
                                        ...
                                        <option value="0"><?php printf('&mdash; %s &mdash;',
                                                esc_html__('Select a Menu')); ?></option>
                                        <?php
                                    ...
                                    ?>
									">
										<span aria-hidden="true"><?php _ex('Edit',
                                                'menu'); ?></span><span class="screen-reader-text">
											<?php
                    ...
                    <p class="button-controls wp-clearfix"><?php submit_button(__('Save Changes'), 'primary left',
                            'nav-menu-locations', false); ?></p>
                    ...
                    <form method="get" action="<?php echo esc_url(admin_url('nav-menus.php')); ?>">
                        ...
                        <select name="menu" id="select-menu-to-edit">
                            ...
                            <?php foreach ((array) $nav_menus as $_nav_menu) : ?>
                                <option value="<?php echo esc_attr($_nav_menu->term_id); ?>" <?php selected($_nav_menu->term_id,
                                    ...
                                    <?php
                                        ...
                                        if (!empty($menu_locations) && in_array($_nav_menu->term_id, $menu_locations,
                                            ...
                                            foreach (array_keys($menu_locations, $_nav_menu->term_id,
                                                true) as $menu_location_key) {
                                             ...
                                             *
                                             */
                                            $locations_listed_per_menu = absint(apply_filters('wp_nav_locations_listed_per_menu',
                                                3));
                                            
                                            $assigned_locations = array_slice($locations_assigned_to_this_menu, 0,
                                ...
                                <div id="nav-menu-header">
                                    <div class="major-publishing-actions wp-clearfix">
                                        ...
                                        <div class="publishing-action">
                                            <?php submit_button(empty($nav_menu_selected_id) ? __('Create Menu') : __('Save Menu'),
                                                'primary large menu-save', 'save_menu', false,
                                                ['id' => 'save_menu_header']); ?>
                                            ...
                                            <fieldset class="menu-settings-group auto-add-pages">
                                                ...
                                                <div class="menu-settings-input checkbox-input">
                                                    <input type="checkbox"<?php checked($auto_add); ?>
                                                           ...
                                                           id="auto-add-pages"
                                                           value="1"/>
                                                    <label for="auto-add-pages"><?php printf(__('Automatically add new top-level pages to this menu'),
                                                            esc_url(admin_url('edit.php?post_type=page'))); ?></label>
                                                </div>
                                            </fieldset>
