<?php
    ...
    class Theme_Upgrader extends WP_Upgrader
    {
        ...
        public function install_strings()
        {
            ...
            $this->strings['parent_theme_not_found'] = sprintf(__('<strong>The parent theme could not be found.</strong> You will need to install the parent theme, %s, before you can use this child theme.'),
                '<strong>%s</strong>');
        ...
        public function check_package($source)
        {
            ...
            $working_directory = str_replace($wp_filesystem->wp_content_dir(), trailingslashit(WP_CONTENT_DIR),
                $source);
            ...
            if (!is_php_version_compatible($requires_php)) {
                ...
                return new WP_Error('incompatible_php_required_version', $this->strings['incompatible_archive'],
                    $error);
            }
