    ...
    class WP_MS_Users_List_Table extends WP_List_Table
    {
        ...
        public function column_blogs($user)
        {
            ...
            foreach ($blogs as $site) {
                 ...
                 *
                 */
                $site_classes = apply_filters('ms_user_list_site_class', $site_classes, $site->userblog_id,
                    $site->site_id,
                    $user);
                ...
                echo '<a href="' . esc_url(network_admin_url('site-info.php?id=' . $site->userblog_id)) . '">' . str_replace('.' . get_network()->domain,
                        '', $site->domain . $path) . '</a>';
        ...
        protected function handle_row_actions($item, $column_name, $primary)
        {
            ...
            if (current_user_can('delete_user', $user->ID) && !in_array($user->user_login, $super_admins, true)) {
                $actions['delete'] = '<a href="' . esc_url(network_admin_url(add_query_arg('_wp_http_referer',
