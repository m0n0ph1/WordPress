    ...
    class WP_Posts_List_Table extends WP_List_Table
    {
        ...
        public function get_columns()
        {
            ...
            if (post_type_supports($post_type, 'comments')
                && !in_array($post_status, ['pending', 'draft', 'future'], true)
            ) {
        ...
        public function inline_edit()
        {
            ...
            foreach ($taxonomy_names as $taxonomy_name) {
                 ...
                 *
                 */
                if (!apply_filters('quick_edit_show_taxonomy', $show_in_quick_edit, $taxonomy_name,
                    $screen->post_type)) {
                    continue;
                }
                                                    ...
                                                    if (post_type_supports($screen->post_type, 'author')) {
                                                        ...
                                                        if (current_user_can($post_type_object->cap->edit_others_posts)) {
                                                            ...
                                                            if (wp_is_large_user_count()) {
                                                                $authors_dropdown = sprintf('<select name="%s" class="%s hidden"></select>',
                                                                    esc_attr($dropdown_name),
                                                                 ...
                                                                 *
                                                                 */
                                                                $users_opt = apply_filters('quick_edit_dropdown_authors_args',
                                                                    $users_opt, $bulk);
                            ...
                            ?>
                                        ...
                                        <fieldset class="inline-edit-col-right">
                                            <div class="inline-edit-col">
                                                ...
                                                <?php if (post_type_supports($screen->post_type,
                                                    'page-attributes')) : ?>
                                                    ...
                                                    <?php if ($post_type_object->hierarchical) : ?>
                                                        ...
                                                        <label>
                                                            ...
                                                            <?php
                                                                 ...
                                                                 *
                                                                 */
                                                                $dropdown_args = apply_filters('quick_edit_dropdown_pages_args',
                                                                    $dropdown_args, $bulk);
                                                    ...
                                                    <label>
                                                        ...
                                                        <select name="page_template">
                                                            ...
                                                            <?php
                                                                ...
                                                                $default_title = apply_filters('default_page_template_title',
                                                                    __('Default template'), 'quick-edit');
                                                            ?>
                                                        ...
                                                        <?php if (current_user_can($taxonomy->cap->assign_terms)) : ?>
                                                            ...
                                                            <div class="inline-edit-tags-wrap">
                                                                <label class="inline-edit-tags">
                                                                    ...
                                                                    <textarea data-wp-taxonomy="<?php echo $taxonomy_name; ?>"
                                                                              cols="22"
                                                                              rows="1"
                                                ...
                                                <?php if (post_type_supports($screen->post_type,
                                                        'comments') || post_type_supports($screen->post_type,
                                                        'trackbacks')) : ?>
                                                ...
                                                <?php if ($bulk && current_theme_supports('post-formats') && post_type_supports($screen->post_type,
                                                        'post-formats')) : ?>
                                                    <?php $post_formats = get_theme_support('post-formats'); ?>

                                                    <label class="alignleft">
                                                        <span class="title"><?php _ex('Format',
                                                                'post format'); ?></span>
        ...
        protected function get_views()
        {
            ...
            if (!empty($this->sticky_posts_count)) {
                ...
                $split = 1 + array_search((isset($status_links['publish']) ? 'publish' : 'all'),
                        array_keys($status_links),
                        true);
                $status_links = array_merge(array_slice($status_links, 0, $split), $sticky_link,
                    array_slice($status_links, $split));
            }
            ...
            <select name="post_format" id="filter-by-format">
                ...
                <?php
                    foreach ($used_post_formats as $used_post_format) {
                        ...
                        ?>
                        <option<?php selected($displayed_post_format,
                            $slug); ?> value="<?php echo esc_attr($slug); ?>"><?php echo esc_html($pretty_name); ?></option>
                        <?php
                    }
                ?>
            </select>
