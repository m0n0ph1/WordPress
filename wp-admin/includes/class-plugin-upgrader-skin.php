        ...
        public function after()
        {
            ...
            if (!empty($this->plugin) && !is_wp_error($this->result) && $this->plugin_active) {
                ...
                printf(
                    ...
                    wp_nonce_url('update.php?action=activate-plugin&networkwide=' . $this->plugin_network_active . '&plugin=' . urlencode($this->plugin),
            ...
            $update_actions = [
                'activate_plugin' => sprintf(
                    ...
                    wp_nonce_url('plugins.php?action=activate&amp;plugin=' . urlencode($this->plugin),
                        'activate-plugin_' . $this->plugin),
                    __('Activate Plugin')
                ),
            ...
            if ($this->plugin_active || !$this->result || is_wp_error($this->result) || !current_user_can('activate_plugin',
                    $this->plugin)) {
