<?php
    ...
    function wp_get_revision_ui_diff($post, $compare_from, $compare_to)
    {
        ...
        foreach (_wp_post_revision_fields($post) as $field => $name) {
             ...
             *
             */
            $content_from = $compare_from ? apply_filters("_wp_post_revision_field_{$field}", $compare_from->$field,
                $field,
                $compare_from, 'from') : '';
            
            /** This filter is documented in wp-admin/includes/revision.php */
            $content_to = apply_filters("_wp_post_revision_field_{$field}", $compare_to->$field, $field, $compare_to,
                'to');
    ...
    function wp_prepare_revisions_for_js($post, $selected_revision_id, $from = null)
    {
        ...
        if (1 === count($revisions)) {
            $revisions[$post->ID] = [
                ...
                'dateShort' => date_i18n(_x('j M @ H:i', 'revision date short format'),
