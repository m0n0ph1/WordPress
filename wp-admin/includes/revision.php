            ...
            if($can_restore)
            {
                $restore_link = str_replace(
                    ...
                    add_query_arg([
                                      ...
                                      'action' => 'restore',
                                  ], admin_url('revision.php')), "restore-post_{$revision->ID}"
                )
                );
            }
            ...
            <div class="diff-title">
                ...
                <div class="author-card<# if ( data.attributes.autosave ) { #> autosave<# } #>">
                    ...
                    <div class="author-info">
                        ...
                        <span class="byline">
						<?php
                            printf(/* translators: %s: User's display name. */ __('Autosave by %s'), '<span class="author-name">{{ data.attributes.author.name }}</span>');
                        ?>
							</span>
                        <# } else if ( data.attributes.current ) { #>
                        <span class="byline">
						<?php
                            printf(/* translators: %s: User's display name. */ __('Current Revision by %s'), '<span class="author-name">{{ data.attributes.author.name }}</span>');
                        ?>
							</span>
                        <# } else { #>
                        <span class="byline">
						<?php
                            printf(/* translators: %s: User's display name. */ __('Revision by %s'), '<span class="author-name">{{ data.attributes.author.name }}</span>');
                        ?>
							</span>
                        <# } #>
