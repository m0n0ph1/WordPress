        ...
        public static function debug_data()
        {
            ...
            $info['wp-core'] = [
                ...
                'fields' => [
                    ...
                    'default_comment_status' => [
                        ...
                        'value' => 'open' === $default_comment_status ? _x('Open', 'comment status') : _x('Closed',
                            'comment status'),
            ...
            if (is_file(ABSPATH . '.htaccess')) {
                ...
                if ($filtered_htaccess_content) {
                    ...
                    /* translators: %s: .htaccess */
                    $htaccess_rules_string = sprintf(__('Your %s file contains only core WordPress features.'),
                        '.htaccess');
                }
            ...
            if ($auto_updates_enabled) {
                ...
                $auto_updates_string = apply_filters('theme_auto_update_debug_string', $auto_updates_string,
                    $active_theme,
                    $enabled);
            ...
            if ($parent_theme) {
                ...
                if (array_key_exists($parent_theme->stylesheet, $theme_updates)) {
                    ...
                    /* translators: %s: Latest theme version number. */
                    $parent_theme_version .= ' ' . sprintf(__('(Latest version: %s)'),
        ...
        public static function format($info_array, $data_type)
        {
            ...
            foreach ($info_array as $section => $details) {
                ...
                $return .= sprintf(
                    "### %s%s ###\n\n",
                    $section_label,
                    (isset($details['show_count']) && $details['show_count'] ? sprintf(' (%d)',
