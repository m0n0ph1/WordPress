    ...
    class WP_Plugins_List_Table extends WP_List_Table
    {
        ...
        public function prepare_items()
        {
            ...
            foreach ((array) $plugins['all'] as $plugin_file => $plugin_data) {
                ...
                if (isset($plugin_info->response[$plugin_file])) {
                    $plugin_data = array_merge((array) $plugin_info->response[$plugin_file],
        ...
        public function single_row($item)
        {
                    ...
                    if ($is_active) {
                        if (current_user_can('manage_network_plugins')) {
                            $actions['deactivate'] = sprintf(
                                ...
                                wp_nonce_url('plugins.php?action=deactivate&amp;plugin=' . urlencode($plugin_file) . '&amp;plugin_status=' . $context . '&amp;paged=' . $page . '&amp;s=' . $s,
                        ...
                        if (current_user_can('manage_network_plugins')) {
                            if ($compatible_php && $compatible_wp) {
                                $actions['activate'] = sprintf(
                                    ...
                                    wp_nonce_url('plugins.php?action=activate&amp;plugin=' . urlencode($plugin_file) . '&amp;plugin_status=' . $context . '&amp;paged=' . $page . '&amp;s=' . $s,
                        ...
                        if (current_user_can('delete_plugins') && !is_plugin_active($plugin_file)) {
                            $actions['delete'] = sprintf(
                                ...
                                wp_nonce_url('plugins.php?action=delete-selected&amp;checked[]=' . urlencode($plugin_file) . '&amp;plugin_status=' . $context . '&amp;paged=' . $page . '&amp;s=' . $s,
                                    'bulk-plugins'),
                                esc_attr($plugin_id_attr),
                                /* translators: %s: Plugin name. */
                    ...
                    if ($restrict_network_active) {
                        ...
                        if (current_user_can('resume_plugin', $plugin_file) && is_plugin_paused($plugin_file)) {
                            $actions['resume'] = sprintf(
                                ...
                                wp_nonce_url('plugins.php?action=resume&amp;plugin=' . urlencode($plugin_file) . '&amp;plugin_status=' . $context . '&amp;paged=' . $page . '&amp;s=' . $s,
                                    'resume-plugin_' . $plugin_file),
                                esc_attr($plugin_id_attr),
                                /* translators: %s: Plugin name. */
            ...
            if ($screen->in_admin('network')) {
                 ...
                 *
                 */
                $actions = apply_filters('network_admin_plugin_action_links', $actions, $plugin_file, $plugin_data,
                    $context);
                 ...
                 *
                 */
                $actions = apply_filters("network_admin_plugin_action_links_{$plugin_file}", $actions, $plugin_file,
                    $plugin_data, $context);
            } else {
                /**
                 ...
                 *
                 */
                $actions = apply_filters("plugin_action_links_{$plugin_file}", $actions, $plugin_file, $plugin_data,
                    $context);
            }
