<?php
    ...
    function wp_dashboard_plugins_output($rss, $args = [])
    {
        ...
        foreach ([$popular] as $feed) {
            ...
            while ((null !== $item_key = array_rand($items)) && str_contains($items[$item_key]->get_description(),
                    'Plugin Name:')) {
                unset($items[$item_key]);
            }
    ...
    function add_object_page($page_title, $menu_title, $capability, $menu_slug, $callback = '', $icon_url = '')
    {
        ...
        return add_menu_page($page_title, $menu_title, $capability, $menu_slug, $callback, $icon_url,
            $_wp_last_object_menu);
    }
