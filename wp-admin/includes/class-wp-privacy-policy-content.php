<?php
    ...
    final class WP_Privacy_Policy_Content
    {
         ...
         *
         * @param string $plugin_name The name of the plugin or theme that is suggesting content for the site's privacy
         *                            policy.
        ...
        public static function policy_text_changed_notice()
        {
            ...
            <div class="policy-text-updated notice notice-warning is-dismissible">
                <p>
                    <?php
                        printf(/* translators: %s: Privacy Policy Guide URL. */ __('The suggested privacy policy text has changed. Please <a href="%s">review the guide</a> and update your privacy policy.'), esc_url(admin_url('privacy-policy-guide.php?tab=policyguide')));
                    ?>
                </p>
            </div>
            <?php
        ...
        public static function notice($post = null)
        {
            ...
            {
                $message .= sprintf(' <a href="%s" target="_blank">%s <span class="screen-reader-text">%s</span></a>', $url, $label, /* translators: Hidden accessibility text. */ __('(opens in a new tab)'));
        ...
        public static function privacy_policy_guide()
        {
            ...
            foreach($content_array as $section)
            {
                ...
                if(! empty($section['removed']))
                {
                    ...
                    $removed = wp_get_admin_notice($removed, [
                        'type' => 'info',
                ...
                <h4 class="privacy-settings-accordion-heading">
                    <button aria-expanded="false"
                            class="privacy-settings-accordion-trigger"
                            aria-controls="privacy-settings-accordion-block-<?php echo $sanitized_policy_name; ?>"
                            type="button">
                ...
                <div id="privacy-settings-accordion-block-<?php echo $sanitized_policy_name; ?>"
                     class="privacy-settings-accordion-panel privacy-text-box-body"
                     hidden="hidden">
                    <?php
                        echo $removed;
        ...
        public static function get_default_content($description = false, $blocks = true)
        {
             ...
             * @since      4.9.6
             */
            return apply_filters_deprecated('wp_get_default_privacy_policy_content', [
                $content,
                $strings,
                $description,
                $blocks,
            ],                              '5.7.0', 'wp_add_privacy_policy_content()');
        }
    }
