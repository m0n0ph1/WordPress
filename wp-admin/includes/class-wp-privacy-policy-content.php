    ...
    final class WP_Privacy_Policy_Content
    {
        ...
        public static function privacy_policy_guide()
        {
            ...
            foreach ($content_array as $section) {
                ...
                if (!empty($section['removed'])) {
                    ...
                    /* translators: %s: Date of plugin deactivation. */
                    $removed = sprintf(__('You deactivated this plugin on %s and may no longer need this policy.'),
                        $date);
        ...
        public static function get_default_content($description = false, $blocks = true)
        {
            ...
            if ($description) {
                ...
                $strings[] = '<p>' . $suggested_text . sprintf(__('Our website address is: %s.'),
                        get_bloginfo('url', 'display')) . '</p>';
            }
