<?php
    ...
    function update_right_now_message()
    {
        ...
        $msg .= sprintf('<span id="wp-version">' . $content . '</span>', get_bloginfo('version', 'display'),
            $theme_name);
    ...
    function wp_plugin_update_row($file, $plugin_data)
    {
        ...
        if (is_network_admin() || !is_multisite()) {
                ...
                if ($compatible_php) {
                    ...
                    /* translators: 1: Plugin name, 2: Details URL, 3: Additional link attributes, 4: Version number, 5: Update URL, 6: Additional link attributes. */
                        ...
                        sprintf(
                            'class="thickbox open-plugin-details-modal" aria-label="%s"',
                            /* translators: 1: Plugin name, 2: Version number. */
                            esc_attr(sprintf(__('View %1$s version %2$s details'), $plugin_name,
             ...
             *
             */
            do_action("in_plugin_update_message-{$file}", $plugin_data,
    ...
    function wp_theme_update_row($theme_key, $theme)
    {
            ...
            if (!current_user_can('update_themes')) {
                ...
                /* translators: 1: Theme name, 2: Details URL, 3: Additional link attributes, 4: Version number. */
                    ...
                    sprintf(
                        ...
                        esc_attr(sprintf(__('View %1$s version %2$s details'), $theme['Name'],
                            $response['new_version']))
                    ),
                    $response['new_version']
                );
         ...
         *
         */
        do_action("in_theme_update_message-{$theme_key}", $theme,
            $response); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
