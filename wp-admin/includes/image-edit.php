                    ...
                    <div class="imgedit-settings">
                        ...
                        ?>
                                        ...
                                        <?php if(isset($meta['width'], $meta['height'])) : ?>
                                            <p>
                                                <?php
                                                    printf(/* translators: %s: Image width and height in pixels. */ __('Original dimensions %s'), '<span class="imgedit-original-dimensions">'.$meta['width'].' &times; '.$meta['height'].'</span>');
                                                ?>
                                            </p>
                                        <?php endif; ?>
    ...
    function wp_save_image_file($filename, $image, $mime_type, $post_id)
    {
        ...
        else
        {
            ...
            $saved = apply_filters_deprecated('wp_save_image_file', [
                ...
                $mime_type,
                $post_id,
            ],                                '3.5.0', 'wp_save_image_editor_file');
            if(null !== $saved)
            {
                return $saved;
            }
