<?php
    ...
    function wp_widget_control($sidebar_args)
    {
        ...
        $key = $sidebar_id ? array_search($widget_id, $sidebars_widgets[$sidebar_id],
            true) : '-1'; // Position of widget in sidebar.
        ...
        $query_arg = ['editwidget' => $widget['id']];
        if ($add_new) {
            $query_arg['addnew'] = 1;
            if ($multi_number) {
        ...
        <div class="widget-inside">
            ...
            <input type="hidden"
                   name="widget_number"
                   class="widget_number"
                   value="<?php echo esc_attr($widget_number); ?>"/>
            <input type="hidden"
                   name="multi_number"
                   class="multi_number"
            ...
            <div class="widget-control-actions">
                <div class="alignleft">
                    <button type="button"
                            class="button-link button-link-delete widget-control-remove"><?php _e('Delete'); ?></button>
                ...
                <div class="alignright<?php echo $noform_class; ?>">
                    <?php submit_button(__('Save'), 'primary widget-control-save right', 'savewidget', false,
                        ['id' => 'widget-' . esc_attr($id_format) . '-savewidget']); ?>
