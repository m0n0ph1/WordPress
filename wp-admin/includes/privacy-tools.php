<?php
    ...
    function _wp_privacy_resend_request($request_id)
    {
        ...
        if (is_wp_error($result)) {
            ...
            return new WP_Error('privacy_request_error',
                __('Unable to initiate confirmation for personal data request.'));
        }
    ...
    function wp_privacy_generate_personal_data_export_group_html($group_data, $group_id = '', $groups_count = 1)
    {
        ...
        foreach ((array) $group_data['items'] as $group_item_id => $group_item_data) {
            ...
            foreach ((array) $group_item_data as $group_item_datum) {
                ...
                if (!str_contains($value, ' ') && (str_starts_with($value, 'http://') || str_starts_with($value,
                            'https://'))) {
    ...
    function wp_privacy_generate_personal_data_export_file($request_id)
    {
        ...
        fwrite($file,
            'body { color: black; font-family: Arial, sans-serif; font-size: 11pt; margin: 15px auto; width: 860px; }');
        ...
        if (true === $zip->open($archive_pathname, ZipArchive::CREATE)) {
            ...
            if (!$error) {
                 ...
                 * @since 4.9.6
                 */
                do_action('wp_privacy_personal_data_export_file_created', $archive_pathname, $archive_url,
                    $html_report_pathname, $request_id, $json_report_pathname);
            }
        } else {
...
###SITEURL###'
         ...
         *
         */
        $headers = apply_filters('wp_privacy_personal_data_email_headers', $headers, $subject, $content, $request_id,
            $email_data);
