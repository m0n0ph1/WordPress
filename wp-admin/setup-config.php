...
<?php
            ...
            <table class="form-table" role="presentation">
                ...
                <tr>
                    ...
                    <td><input name="uname"
                               ...
                               size="25"
                               placeholder="<?php echo htmlspecialchars(_x('username', 'example username'),
                                   ENT_QUOTES); ?>"/>
                    ...
                    <td>
                        <div class="wp-pwd">
                            <input name="pwd"
                                   ...
                                   size="25"
                                   placeholder="<?php echo htmlspecialchars(_x('password', 'example password'),
                                       ENT_QUOTES); ?>"
                                   autocomplete="off"
                                   spellcheck="false"/>
                            <button type="button"
                    ...
                    <td><input name="dbhost"
                        ...
                        <p id="dbhost-desc">
                            <?php
                                ...
                                printf(__('You should be able to get this info from your web host, if %s does not work.'),
                                    '<code>localhost</code>');
                            ?>
                        </p></td>
                </tr>
    ...
    ?>
        ...
        <p id="wp-config-description">
            <?php
                /* translators: %s: wp-config.php */
                printf(__('You can create the %s file manually and paste the following text into it.'),
                    '<code>wp-config.php</code>');
