        ...
        switch ($action) {
            case 'newuser':
                ...
                if (!is_array($_POST['user']) || empty($user['username']) || empty($user['email'])) {
                    ...
                    $user_id = wpmu_create_user(esc_html(strtolower($user['username'])), $password,
                        esc_html($user['email']));
            ...
            default:
                ...
                $referer = apply_filters('handle_network_bulk_actions-' . get_current_screen()->id, $referer, $action,
                    $userids, $id); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
    ...
    <div class="wrap">
                ...
                <form action="site-users.php?action=adduser" id="adduser" method="post">
                    ...
                    <table class="form-table" role="presentation">
                        <tr>
                            ...
                            <td><input type="text" class="regular-text wp-suggest-user" name="newuser" id="newuser"/>
                            </td>
                        </tr>
                        <tr>
                    ...
                    <?php submit_button(__('Add User'), 'primary', 'add-user', true,
                        ['id' => 'submit-add-existing-user']); ?>
                </form>
            <?php endif; ?>
        ...
        <?php
            ...
            if (current_user_can('create_users') && apply_filters('show_network_site_users_add_new_form', true)) :
                ...
                <form action="<?php echo esc_url(network_admin_url('site-users.php?action=newuser')); ?>"
                      id="newuser"
                      method="post">
                    <input type="hidden" name="id" value="<?php echo esc_attr($id); ?>"/>
                    <table class="form-table" role="presentation">
                    ...
                    <?php submit_button(__('Add New User'), 'primary', 'add-user', true,
                        ['id' => 'submit-add-user']); ?>
                </form>
            <?php endif; ?>
    </div>
