    ...
    if ($action) {
        switch ($action) {
            ...
            case 'update-selected':
                ...
                $url = self_admin_url('update.php?action=update-selected-themes&amp;themes=' . urlencode(implode(',',
                        $themes)));
        ...
        <?php
            ...
            if (isset($_GET['enabled'])) {
                ...
                if (1 === $disabled) {
                    ...
                    $message = sprintf(
                    /* translators: %s: Number of themes. */
                        _n('%s theme will no longer be auto-updated.', '%s themes will no longer be auto-updated.',
                            $disabled),
                        number_format_i18n($disabled)
                    );
                }
