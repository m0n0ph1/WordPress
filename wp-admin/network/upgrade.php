<?php
    ...
    get_current_screen()->set_help_sidebar('<p><strong>'.__('For more information:').'</strong></p>'.'<p>'.__('<a href="https://wordpress.org/documentation/article/network-admin-updates-screen/">Documentation on Upgrade Network</a>').'</p>'.'<p>'.__('<a href="https://wordpress.org/support/forums/">Support forums</a>').'</p>');
    ...
    switch($action)
    {
        case 'upgrade':
            ...
            foreach((array) $site_ids as $site_id)
            {
                ...
                echo "<li>$siteurl</li>";
                $response = wp_remote_get($upgrade_url, [
                    'timeout' => 120,
                    'httpversion' => '1.1',
                    'sslverify' => false,
                ]);
            ...
            echo '</ul>';
            ?><p><?php _e('If your browser does not start loading the next page automatically, click this link:'); ?> <a
                    class="button"
