        ...
        <form method="post" action="site-info.php?action=update-site">
            ...
            <table class="form-table" role="presentation">
                <?php
                    ...
                    // For any other site, the scheme, domain, and path can all be changed.
                        ...
                        <tr class="form-field form-required">
                            ...
                            <td><input name="blog[url]"
                                       type="text"
                                       id="url"
                                       value="<?php echo $parsed_scheme . '://' . esc_attr($details->domain) . esc_attr($details->path); ?>"/>
                            </td>
                        </tr>
                    <?php endif; ?>
                ...
                <tr class="form-field">
                    ...
                    <td><input name="blog[registered]"
                               type="text"
                               id="blog_registered"
                               value="<?php echo esc_attr($details->registered); ?>"/></td>
                </tr>
                <tr class="form-field">
                    <th scope="row"><label for="blog_last_updated"><?php _e('Last Updated'); ?></label></th>
                    <td><input name="blog[last_updated]"
                               type="text"
                               id="blog_last_updated"
                               value="<?php echo esc_attr($details->last_updated); ?>"/></td>
                </tr>
                <?php
                        ...
                        <fieldset>
                            ...
                            <?php foreach ($attribute_fields as $field_key => $field_label) : ?>
                                <label><input type="checkbox"
                                              name="blog[<?php echo $field_key; ?>]"
                                              value="1" <?php checked((bool) $details->$field_key,
                                        true); ?> <?php disabled(!in_array((int) $details->$field_key, [0, 1],
                                        true)); ?> />
