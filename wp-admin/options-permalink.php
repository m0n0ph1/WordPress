        ...
        if (isset($_POST['permalink_structure'])) {
            ...
            if (!empty($permalink_structure)) {
                ...
                if ($index_php_prefix && $blog_prefix) {
                    $permalink_structure = $index_php_prefix . preg_replace('#^/?index\.php#', '',
                            $permalink_structure);
                } else {
        ...
        <?php
            ...
            $default_structures = [
                ...
                [
                    ...
                    'example' => $url_base . '/' . gmdate('Y/m/d') . '/' . _x('sample-post',
                ...
                [
                    ...
                    'example' => $url_base . '/' . gmdate('Y/m') . '/' . _x('sample-post',
                            'sample permalink structure') . '/',
                ],
                [
                    'id' => 'numeric',
                                                ...
                                                <?php foreach ($available_tags as $tag => $explanation) : ?>
                                                    <li>
                                                        <button type="button"
                                                                ...
                                                                aria-label="<?php echo esc_attr(sprintf($explanation,
                                                                    $tag)); ?>"
                                                                data-added="<?php echo esc_attr(sprintf($tag_added,
                                                                    $tag)); ?>"
                                                                data-removed="<?php echo esc_attr(sprintf($tag_removed,
                                                                    $tag)); ?>"
                                                                data-used="<?php echo esc_attr(sprintf($tag_already_used,
                                                                    $tag)); ?>">
