            ...
            public static function register($wp_customize)
            {
                ...
                $wp_customize->add_control(
                    ...
                    [
                        ...
                        'description' => __('Scales the logo to half its uploaded size, making it sharp on high-res screens.',
                            'twentytwenty'),
                    ]
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        ...
                        [
                            'section' => 'colors',
                            'settings' => 'accent_hue',
                            'description' => __('Apply a custom color for links, buttons, featured images.',
                                'twentytwenty'),
                            'mode' => 'hue',
                ...
                $wp_customize->add_section(
                    ...
                    [
                        ...
                        'capability' => 'edit_theme_options',
                        'description' => __('Settings for the "Cover Template" page template. Add a featured image to use as background.',
                            'twentytwenty'),
                        'priority' => 42,
                    ]
                );
                ...
                $wp_customize->add_control(
                    new WP_Customize_Color_Control(
                        ...
                        [
                            ...
                            'description' => __('The color used for the overlay. Defaults to the accent color.',
                                'twentytwenty'),
                            'section' => 'cover_template_options',
                        ]
                    )
                ...
                $wp_customize->add_control(
                    ...
                    [
                        ...
                        'description' => __('Make sure that the contrast is high enough so that the text is readable.',
                            'twentytwenty'),
                        'section' => 'cover_template_options',
                        'type' => 'range',
