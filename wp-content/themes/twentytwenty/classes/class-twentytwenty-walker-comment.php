    ...
    if (!class_exists('TwentyTwenty_Walker_Comment')) {
        ...
        class TwentyTwenty_Walker_Comment extends Walker_Comment
        {
            ...
            protected function html5_comment($comment, $depth, $args)
            {
                ...
                ?> id="comment-<?php comment_ID(); ?>" <?php comment_class($this->has_children ? 'parent' : '',
                $comment); ?>>
                    ...
                    <footer class="comment-meta">
                            ...
                            <?php
                                ...
                                if (0 !== $args['avatar_size']) {
                                    if (empty($comment_author_url)) {
                                        ...
                                        printf('<a href="%s" rel="external nofollow" class="url">',
                        ...
                        <div class="comment-metadata">
                            <?php
                                ...
                                $comment_timestamp = sprintf(__('%1$s at %2$s', 'twentytwenty'),
                        ...
                        if ($comment_reply_link || $by_post_author) {
                            ...
                            <footer class="comment-footer-meta">
                                ...
                                <?php
                                    ...
                                    if ($by_post_author) {
                                        echo '<span class="by-post-author">' . __('By Post Author',
                                                'twentytwenty') . '</span>';
                                    }
                                ?>
