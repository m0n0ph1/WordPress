<?php
    ...
    function twentytwenty_theme_support()
    {
        ...
        if (version_compare($GLOBALS['wp_version'], '6.3', '<')) {
            ...
            add_filter('print_scripts_array', [$loader, 'migrate_legacy_strategy_script_data'], 100);
        }
    }
...
// Block Patterns.
    ...
    function twentytwenty_register_styles()
    {
        ...
        wp_enqueue_style('twentytwenty-style', get_stylesheet_uri(), [], $theme_version);
        ...
        // Add print CSS.
        wp_enqueue_style('twentytwenty-print-style', get_template_directory_uri() . '/print.css', null, $theme_version,
            'print');
    }
    ...
    function twentytwenty_register_scripts()
    {
         ...
         */
        wp_enqueue_script('twentytwenty-js', get_template_directory_uri() . '/assets/js/index.js', [], $theme_version);
    ...
    function twentytwenty_block_editor_styles()
    {
        ...
        wp_enqueue_style('twentytwenty-block-editor-styles', get_theme_file_uri('/assets/css/editor-style-block.css'),
            [],
        ...
        wp_enqueue_script('twentytwenty-block-editor-script', get_theme_file_uri('/assets/js/editor-script-block.js'),
            ['wp-blocks', 'wp-dom'], wp_get_theme()->get('Version'), ['in_footer' => true]);
    }
    ...
    {
        return preg_replace('/<a(.*)>(.*)<\/a>/iU',
            sprintf('<div class="read-more-button-wrap"><a$1><span class="faux-button">$2</span> <span class="screen-reader-text">"%1$s"</span></a></div>',
                get_the_title(get_the_ID())), $html);
    }
    ...
    function twentytwenty_customize_controls_enqueue_scripts()
    {
        ...
        wp_enqueue_script('twentytwenty-customize', get_template_directory_uri() . '/assets/js/customize.js',
            ['jquery'],
            $theme_version);
        
        // Add script for color calculations.
        wp_enqueue_script('twentytwenty-color-calculations',
            get_template_directory_uri() . '/assets/js/color-calculations.js', ['wp-color-picker'], $theme_version);
        
        // Add script for controls.
        wp_enqueue_script('twentytwenty-customize-controls',
            get_template_directory_uri() . '/assets/js/customize-controls.js',
            ['twentytwenty-color-calculations', 'customize-controls', 'underscore', 'jquery'], $theme_version);
        wp_localize_script('twentytwenty-customize-controls', 'twentyTwentyBgColors',
    ...
    function twentytwenty_customize_preview_init()
    {
        ...
        wp_enqueue_script('twentytwenty-customize-preview', get_theme_file_uri('/assets/js/customize-preview.js'),
            ['customize-preview', 'customize-selective-refresh', 'jquery'], $theme_version, ['in_footer' => true]);
        wp_localize_script('twentytwenty-customize-preview', 'twentyTwentyBgColors',
            twentytwenty_get_customizer_color_vars());
        wp_localize_script('twentytwenty-customize-preview', 'twentyTwentyPreviewEls',
            ...
            'header-footer' => [
                'accent' => [
                    'color' => [
                        ...
                        '.modal-menu a',
                        '.footer-menu a, .footer-widgets a:where(:not(.wp-block-button__link))',
