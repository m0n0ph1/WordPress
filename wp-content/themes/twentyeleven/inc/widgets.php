<?php
    ...
    class Twenty_Eleven_Ephemera_Widget extends WP_Widget
    {
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                [
                    ...
                    'description' => __('Use this widget to list your recent Aside, Status, Quote, and Link posts',
                        'twentyeleven'),
        ...
        public function widget($args, $instance)
        {
            ...
            $args['title'] = apply_filters('widget_title',
                empty($instance['title']) ? __('Ephemera', 'twentyeleven') : $instance['title'], $instance,
                $this->id_base);
            ...
            if ($ephemera->have_posts()) :
                ...
                <ol>
                    <?php
						...
						<?php comments_popup_link(__('0 <span class="reply">comments &rarr;</span>', 'twentyeleven'),
                            __('1 <span class="reply">comment &rarr;</span>', 'twentyeleven'),
