...
// Set the content width based on the theme's design and stylesheet.
        ...
        function twentyeleven_setup()
        {
            ...
            if (!function_exists('get_custom_header')) {
                ...
                add_custom_image_header($custom_header_support['wp-head-callback'],
                    $custom_header_support['admin-head-callback'], $custom_header_support['admin-preview-callback']);
    ...
    if (!function_exists('twentyeleven_continue_reading_link')) :
        ...
        {
            return ' <a href="' . esc_url(get_permalink()) . '">' . __('Continue reading <span class="meta-nav">&rarr;</span>',
                    'twentyeleven') . '</a>';
        }
        ...
        function twentyeleven_comment($comment, $args, $depth)
        {
            ...
            switch ($comment->comment_type) :
                ...
                case 'trackback':
                    ...
                    <p><?php _e('Pingback:',
                            'twentyeleven'); ?><?php comment_author_link(); ?><?php edit_comment_link(__('Edit',
                            'twentyeleven'), '<span class="edit-link">', '</span>'); ?></p>
                    <?php
                    break;
                default:
                    ?>
                                ...
                                <?php
                                    ...
                                    /* translators: 1: Comment author, 2: Date and time. */
                                        ...
                                        sprintf(
                                            ...
                                            sprintf(__('%1$s at %2$s', 'twentyeleven'), get_comment_date(),
                                                get_comment_time())
                                        )
                                    );
                                ?>
    ...
    if (!function_exists('twentyeleven_posted_on')) :
        ...
        function twentyeleven_posted_on()
        {
            ...
            /* translators: 1: The permalink, 2: Time, 3: Date and time, 4: Date and time, 5: Author posts, 6: Author post link text, 7: Author display name. */
                __('<span class="sep">Posted on </span><a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s">%4$s</time></a><span class="by-author"> <span class="sep"> by </span> <span class="author vcard"><a class="url fn n" href="%5$s" title="%6$s" rel="author">%7$s</a></span></span>',
                    'twentyeleven'),
    ...
    {
        echo '<div class="skip-link"><a class="assistive-text" href="#content">' . esc_html__('Skip to primary content',
                'twentyeleven') . '</a></div>';
        if (!is_singular()) {
            echo '<div class="skip-link"><a class="assistive-text" href="#secondary">' . esc_html__('Skip to secondary content',
                    'twentyeleven') . '</a></div>';
        }
    }
