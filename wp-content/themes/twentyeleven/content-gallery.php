        ...
        <div class="entry-content">
            ...
            <?php
                ...
                if($images) :
                    ...
                    <p><em>
                            <?php
                                printf(/* translators: 1: Link attributes, 2: Number of photos. */ _n('This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'twentyeleven'), /* translators: %s: Post title. */ 'href="'.esc_url(get_permalink()).'" title="'.esc_attr(sprintf(__('Permalink to %s', 'twentyeleven'), the_title_attribute('echo=0'))).'" rel="bookmark"', number_format_i18n($total_images));
                            ?>
                        </em></p>
