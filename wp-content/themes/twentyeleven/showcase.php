                        ...
                        <?php
                            ...
                            while ($featured->have_posts()) :
                                ...
                                */
                                ...
                                <section class="featured-post <?php echo esc_attr($feature_class); ?>"
                                         id="featured-post-<?php echo esc_attr($counter_slider); ?>">
                                    ...
                                    <?php
                                        ...
                                        if (has_post_thumbnail()) {
                                            ...
                                            $title = sprintf(__('Permalink to %s', 'twentyeleven'),
                                                the_title_attribute('echo=0'));
                                            ?>
                                            <a href="<?php the_permalink(); ?>"
                                               title="<?php echo esc_attr($title); ?>"
                                               rel="bookmark"><?php the_post_thumbnail($thumbnail_size); ?></a>
                                            <?php
                                        }
                                    ?>
                                    ...
                                    <ul>
                                        <?php
                                            ...
                                            while ($featured->have_posts()) :
                                                ...
                                                /* translators: %s: Post title. */
                                                $title = sprintf(__('Featuring: %s', 'twentyeleven'),
                                                    the_title_attribute('echo=0'));
                                                ?>
                                                <li>
                                                    <a href="#featured-post-<?php echo esc_attr($counter_slider); ?>"<?php echo $class; ?>><span
                                                                class="feature-slider-tooltip"
                                                                aria-hidden="true"
                                                                title="<?php echo esc_attr($title); ?>"></span><span
                                                                class="screen-reader-text"><?php echo esc_html($title); ?></span></a>
                                                </li>
                                            <?php endwhile; ?>
                                    </ul>
                                </nav>
