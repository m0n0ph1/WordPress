        ...
        <?php
            ...
            while(have_posts()) :
                ...
                elseif(is_singular('post'))
                {
                    ...
                    the_post_navigation([
                                            'next_text' => '<span class="meta-nav" aria-hidden="true">'.__('Next', 'twentysixteen').'</span> './* translators: Hidden accessibility text. */ '<span class="screen-reader-text">'.__('Next post:', 'twentysixteen').'</span> '.'<span class="post-title">%title</span>',
