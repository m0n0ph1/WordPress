    ...
    if (!function_exists('twentysixteen_entry_meta')) :
        ...
        function twentysixteen_entry_meta()
        {
            ...
            if (!is_singular() && !post_password_required() && (comments_open() || get_comments_number())) {
                ...
                comments_popup_link(sprintf(__('Leave a comment<span class="screen-reader-text"> on %s</span>',
                    'twentysixteen'), get_the_title()));
                echo '</span>';
            }
        }
    endif;
    ...
    if (!function_exists('twentysixteen_entry_taxonomies')) :
        ...
        function twentysixteen_entry_taxonomies()
        {
            ...
            $tags_list = get_the_tag_list('',
                _x(', ', 'Used between list items, there is a space after the comma.', 'twentysixteen'));
    ...
    if (!function_exists('twentysixteen_excerpt_more') && !is_admin()) :
        ...
        function twentysixteen_excerpt_more()
        {
            $link = sprintf(
                ...
                /* translators: %s: Post title. Only visible to screen readers. */
                sprintf(__('Continue reading<span class="screen-reader-text"> "%s"</span>', 'twentysixteen'),
