<?php
    ...
    function twentyfourteen_scripts()
    {
        ...
        $font_version = (0 === strpos((string) twentyfourteen_font_url(),
        ...
        wp_enqueue_style('twentyfourteen-block-style', get_template_directory_uri() . '/css/blocks.css',
            ['twentyfourteen-style'], '20230630');
        
        // Load the Internet Explorer specific stylesheet.
        wp_enqueue_style('twentyfourteen-ie', get_template_directory_uri() . '/css/ie.css', ['twentyfourteen-style'],
            '20140711');
        ...
        if (is_singular() && wp_attachment_is_image()) {
            wp_enqueue_script('twentyfourteen-keyboard-image-navigation',
                get_template_directory_uri() . '/js/keyboard-image-navigation.js', ['jquery'], '20150120');
        }
