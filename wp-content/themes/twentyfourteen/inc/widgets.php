<?php
    ...
    class Twenty_Fourteen_Ephemera_Widget extends WP_Widget
    {
                                            ...
                                            if(has_post_format('gallery')) :
                                                if(post_password_required()) :
                                                    ...
                                                    <p class="wp-caption-text">
                                                        <?php
                                                            printf(/* translators: 1: Post permalink, 2: Number of images in the gallery. */ _n('This gallery contains <a href="%1$s" rel="bookmark">%2$s photo</a>.', 'This gallery contains <a href="%1$s" rel="bookmark">%2$s photos</a>.', $total_images, 'twentyfourteen'), esc_url(get_permalink()), number_format_i18n($total_images));
                                                        ?>
                                                    </p>
                                                <?php
                                                endif;
        ...
        public function form($instance)
        {
            ...
            <p><label
                    for="<?php echo esc_attr($this->get_field_id('format')); ?>"><?php _e('Post format to show:', 'twentyfourteen'); ?></label>
