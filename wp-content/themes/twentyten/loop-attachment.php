    ...
    if(have_posts())
    {
        while(have_posts()) :
            ...
            if(! empty($post->post_parent)) :
                ...
                ?>
                <p class="page-title"><a href="<?php echo esc_url(get_permalink($post->post_parent)); ?>"
                    ...
                    <div class="entry-attachment">
                        <?php
                            if(wp_attachment_is_image()) :
                                ...
                                ?>
                                <p class="attachment"><a href="<?php echo esc_url($next_attachment_url); ?>"
                            ...
                            <?php else : ?>
                                <a href="<?php echo esc_url(wp_get_attachment_url()); ?>"
                                   title="<?php the_title_attribute(); ?>"
                                   rel="attachment"><?php echo esc_html(wp_basename(get_permalink())); ?></a>
                            <?php endif; ?>
