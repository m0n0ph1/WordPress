...
<div class="wp-block-group alignwide" style="margin-top:5px">
    ...
    <!-- wp:search {"label":"<?php echo esc_html_x('Search', 'label',
        ...
        'twentytwentythree'); ?>","showLabel":false,"width":100,"widthUnit":"%","buttonText":"<?php esc_attr_e('Search',
        'twentytwentythree'); ?>","buttonUseIcon":true,"align":"center"} /-->
</div>
<!-- /wp:group -->
