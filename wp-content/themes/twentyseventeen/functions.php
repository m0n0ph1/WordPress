...
// add_filter( 'wp_resource_hints', 'twentyseventeen_resource_hints', 10, 2 );
    ...
    function twentyseventeen_excerpt_more($link)
    {
        ...
        $link = sprintf('<p class="link-more"><a href="%1$s" class="more-link">%2$s</a></p>', esc_url(get_permalink(get_the_ID())), /* translators: %s: Post title. Only visible to screen readers. */ sprintf(__('Continue reading<span class="screen-reader-text"> "%s"</span>', 'twentyseventeen'), get_the_title(get_the_ID())));
    ...
    function twentyseventeen_scripts()
    {
        ...
        // Theme stylesheet.
        wp_enqueue_style('twentyseventeen-style', get_stylesheet_uri(), [], '20230808');
        // Theme block stylesheet.
        wp_enqueue_style('twentyseventeen-block-style', get_theme_file_uri('/assets/css/blocks.css'), ['twentyseventeen-style'], '20220912');
        // Load the dark colorscheme.
        if('dark' === get_theme_mod('colorscheme', 'light') || is_customize_preview())
        {
            wp_enqueue_style('twentyseventeen-colors-dark', get_theme_file_uri('/assets/css/colors-dark.css'), ['twentyseventeen-style'], '20191025');
        }
        ...
        wp_enqueue_script('twentyseventeen-global', get_theme_file_uri('/assets/js/global.js'), ['jquery'], '20211130', [
        ...
        if(has_nav_menu('top'))
        {
            wp_enqueue_script('twentyseventeen-navigation', get_theme_file_uri('/assets/js/navigation.js'), ['jquery'], '20210122', [
                'in_footer' => false, // Because involves header.
                'strategy' => 'defer',
            ]);
        ...
        wp_enqueue_script('jquery-scrollto', get_theme_file_uri('/assets/js/jquery.scrollTo.js'), ['jquery'], '2.1.3', [
            'in_footer' => true,
            'strategy' => 'defer',
        ]);
    ...
    {
        // Block styles.
        wp_enqueue_style('twentyseventeen-block-editor-style', get_theme_file_uri('/assets/css/editor-blocks.css'), [], '20230614');
        // Add custom fonts.
        $font_version = (0 === strpos((string) twentyseventeen_fonts_url(), get_template_directory_uri().'/')) ? '20230328' : null;
        wp_enqueue_style('twentyseventeen-fonts', twentyseventeen_fonts_url(), [], $font_version);
    }
