...
// add_filter( 'wp_resource_hints', 'twentyseventeen_resource_hints', 10, 2 );
    ...
    function twentyseventeen_scripts()
    {
        ...
        $font_version = (0 === strpos((string) twentyseventeen_fonts_url(),
        ...
        wp_enqueue_style('twentyseventeen-block-style', get_theme_file_uri('/assets/css/blocks.css'),
            ['twentyseventeen-style'], '20220912');
        
        // Load the dark colorscheme.
        if ('dark' === get_theme_mod('colorscheme', 'light') || is_customize_preview()) {
            wp_enqueue_style('twentyseventeen-colors-dark', get_theme_file_uri('/assets/css/colors-dark.css'),
                ['twentyseventeen-style'], '20191025');
        }
        
        // Register the Internet Explorer 9 specific stylesheet, to fix display issues in the Customizer.
        if (is_customize_preview()) {
            wp_register_style('twentyseventeen-ie9', get_theme_file_uri('/assets/css/ie9.css'),
        ...
        wp_register_style('twentyseventeen-ie8', get_theme_file_uri('/assets/css/ie8.css'), ['twentyseventeen-style'],
            '20161202');
        ...
        wp_register_script('twentyseventeen-skip-link-focus-fix',
            get_theme_file_uri('/assets/js/skip-link-focus-fix.js'),
            [], '20161114', ['in_footer' => true]);
