<?php
    ...
    function twentythirteen_admin_header_image()
    {
        ...
        ?>
        <div id="headimg"
             style="background: url(<?php echo esc_url(get_header_image()); ?>) no-repeat scroll top; background-size: 1600px auto;">
            <div class="home-link">
                ...
                <h2 id="desc"
                    ...
                    style="<?php echo esc_attr($style); ?>"><?php bloginfo('description'); ?></h2>
            </div>
        </div>
        <?php
    }
