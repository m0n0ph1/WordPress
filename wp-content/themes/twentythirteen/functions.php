<?php
    ...
    function twentythirteen_scripts_styles()
    {
        ...
        $font_version = (0 === strpos((string) twentythirteen_fonts_url(),
        ...
        wp_enqueue_style('twentythirteen-block-style', get_template_directory_uri() . '/css/blocks.css',
            ['twentythirteen-style'], '20230621');
        
        // Registers the Internet Explorer specific stylesheet.
        wp_register_style('twentythirteen-ie', get_template_directory_uri() . '/css/ie.css', ['twentythirteen-style'],
            '20150214');
...
// add_filter( 'wp_resource_hints', 'twentythirteen_resource_hints', 10, 2 );
            ...
            <nav class="navigation post-navigation">
                ...
                <div class="nav-links">
                    ...
                    <?php previous_post_link('%link',
                        _x('<span class="meta-nav">&larr;</span> %title', 'Previous post link', 'twentythirteen')); ?>
                    <?php next_post_link('%link',
                        _x('%title <span class="meta-nav">&rarr;</span>', 'Next post link', 'twentythirteen')); ?>
    ...
    {
        wp_enqueue_script('twentythirteen-customizer', get_template_directory_uri() . '/js/theme-customizer.js',
            ['customize-preview'], '20200516', ['in_footer' => true]);
    }
