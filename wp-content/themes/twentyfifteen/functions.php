<?php
    ...
    function twentyfifteen_scripts()
    {
        ...
        $font_version = (0 === strpos((string) twentyfifteen_fonts_url(),
        ...
        wp_enqueue_style('twentyfifteen-block-style', get_template_directory_uri() . '/css/blocks.css',
            ['twentyfifteen-style'], '20230623');
        
        // Register the Internet Explorer specific stylesheet.
        wp_register_style('twentyfifteen-ie', get_template_directory_uri() . '/css/ie.css', ['twentyfifteen-style'],
            '20220908');
        wp_style_add_data('twentyfifteen-ie', 'conditional', 'lt IE 9');
        
        // Register the Internet Explorer 7 specific stylesheet.
        wp_register_style('twentyfifteen-ie7', get_template_directory_uri() . '/css/ie7.css', ['twentyfifteen-style'],
            '20141210');
        wp_style_add_data('twentyfifteen-ie7', 'conditional', 'lt IE 8');
        
        // Skip-link fix is no longer enqueued by default.
        wp_register_script('twentyfifteen-skip-link-focus-fix',
        ...
        if (is_singular() && wp_attachment_is_image()) {
            wp_enqueue_script('twentyfifteen-keyboard-image-navigation',
                get_template_directory_uri() . '/js/keyboard-image-navigation.js', ['jquery'], '20141210');
        }
        ...
        wp_localize_script(
            ...
            [
                ...
                /* translators: Hidden accessibility text. */
                'collapse' => '<span class="screen-reader-text">' . __('collapse child menu',
                        'twentyfifteen') . '</span>',
            ]
        );
    }
