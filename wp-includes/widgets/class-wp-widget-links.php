        ...
        public function form($instance)
        {
            ...
            <p>
                <input class="checkbox"
                       type="checkbox"<?php checked($instance['images'], true); ?>
                ...
                <input class="checkbox"
                       type="checkbox"<?php checked($instance['name'], true); ?>
                ...
                <input class="checkbox"
                       type="checkbox"<?php checked($instance['description'], true); ?>
                ...
                <input class="checkbox"
                       type="checkbox"<?php checked($instance['rating'], true); ?>
            ...
            <p>
                ...
                <input id="<?php echo $this->get_field_id('limit'); ?>"
                       ...
                       type="text"
                       value="<?php echo (-1 !== $limit) ? (int) $limit : ''; ?>"
                       size="3"/>
            </p>
            <?php
        }
