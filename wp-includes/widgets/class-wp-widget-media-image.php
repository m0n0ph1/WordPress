    ...
    class WP_Widget_Media_Image extends WP_Widget_Media
    {
        ...
        public function __construct()
        {
            ...
            $this->l10n = array_merge($this->l10n, [
                ...
                'missing_attachment' => sprintf(/* translators: %s: URL to media library. */ __('That image cannot be found. Check your <a href="%s">media library</a> and make sure it was not deleted.'), esc_url(admin_url('upload.php'))),
        ...
        public function render_control_template_scripts()
        {
            ...
            <script type="text/html" id="tmpl-wp-media-widget-image-fields">
                ...
                <p class="media-widget-image-link">
                    ...
                    <input id="{{ elementIdPrefix }}linkUrl"
                           type="text"
                           class="widefat link"
                           value="{{ data.link_url }}"
                           placeholder="https://"
            ...
            <script type="text/html" id="tmpl-wp-media-widget-image-preview">
                ...
                aria-label="
                <?php
                    echo esc_attr(sprintf(/* translators: %s: The image file name. */ __('The current image has no alternative text. The file name is: %s'), '{{ data.currentFilename }}'));
                ?>
                "
                <# } #>
                />
