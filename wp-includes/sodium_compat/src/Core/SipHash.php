<?php
    ...
    class ParagonIE_Sodium_Core_SipHash extends ParagonIE_Sodium_Core_Util
    {
        ...
        {
            # v0 += v1;
            [$v[0], $v[1]] = self::add([$v[0], $v[1]], [$v[2], $v[3]]);

            #  v1=ROTL(v1,13);
            [$v[2], $v[3]] = self::rotl_64((int) $v[2], (int) $v[3], 13);
            ...
            # v2 += v3;
            [$v[4], $v[5]] = self::add([(int) $v[4], (int) $v[5]], [(int) $v[6], (int) $v[7]]);

            # v3=ROTL(v3,16);
            [$v[6], $v[7]] = self::rotl_64((int) $v[6], (int) $v[7], 16);
            ...
            # v0 += v3;
            [$v[0], $v[1]] = self::add([(int) $v[0], (int) $v[1]], [(int) $v[6], (int) $v[7]]);
            ...
            # v2 += v1;
            [$v[4], $v[5]] = self::add([(int) $v[4], (int) $v[5]], [(int) $v[2], (int) $v[3]]);
