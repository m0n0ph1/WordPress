<?php
    ...
    abstract class Crypto32
    {
        ...
        public static function aead_xchacha20poly1305_ietf_decrypt(
            ...
            $nonceLast = "\x00\x00\x00\x00".ParagonIE_Sodium_Core32_Util::substr($nonce, 16, 8);
        ...
        {
            return ParagonIE_Sodium_Core32_HSalsa20::hsalsa20(str_repeat("\x00", 16), self::scalarmult($sk, $pk));
        }
