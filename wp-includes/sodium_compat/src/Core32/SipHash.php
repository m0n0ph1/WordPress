<?php
    ...
    class SipHash extends ParagonIE_Sodium_Core32_Util
    {
        public static function sipHash24($in, $key)
        {
            ...
            $v = [
                new ParagonIE_Sodium_Core32_Int64([0x736f, 0x6d65, 0x7073, 0x6575]),
                new ParagonIE_Sodium_Core32_Int64([0x646f, 0x7261, 0x6e64, 0x6f6d]),
                new ParagonIE_Sodium_Core32_Int64([0x6c79, 0x6765, 0x6e65, 0x7261]),
                new ParagonIE_Sodium_Core32_Int64([0x7465, 0x6462, 0x7974, 0x6573])
            ];
            ...
            # b = ( ( u64 )inlen ) << 56;
            $b = new ParagonIE_Sodium_Core32_Int64([($inlen << 8) & 0xffff, 0, 0, 0]);
