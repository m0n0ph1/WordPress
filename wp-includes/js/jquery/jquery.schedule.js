(function ($) {
    ...
    $.scheduler.prototype = {
        schedule: function () {
            var ctx = {
                'id': null, 'time': 1000, 'repeat': false, 'protect': false, 'obj': null, 'func': function () {
                }, 'args': []
            };
            ...
            if (!_isfn(ctx['func'])) {
                if (ctx['obj'] != null && typeof ctx['obj'] == 'object' && typeof ctx['func'] == 'string' && _isfn(ctx['obj'][ctx['func']]))
    ...
    $.extend({
        scheduler$: new $.scheduler(), schedule: function () {
