...
// EXPORTS
    ...
    const border = ([color, borderStyle, width, radius, borderTop, borderRight, borderBottom, borderLeft]);
    ...
    /* harmony default export */
    const styles_color = ([color_text, color_gradient, color_background]);
    ...
    /* harmony default export */
    const outline = ([outline_color, outlineStyle, offset, outline_width]);
    ...
    /* harmony default export */
    const spacing = ([spacing_margin, spacing_padding]);
    ...
    /* harmony default export */
    const typography = ([fontFamily, fontSize, fontStyle, fontWeight, letterSpacing, lineHeight, textColumns, textDecoration, textTransform]);
