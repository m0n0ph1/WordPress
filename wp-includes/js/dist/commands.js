 ...
 * -----------------------------------------------------------------------------------------------*/
        ...
        const $5cb92bef7577960e$export$177fb62ff3ec1f22 = /*#__PURE__*/ (0, external_React_namespaceObject.forwardRef)((props, forwardedRef) => {
            const {
                disableOutsidePointerEvents: disableOutsidePointerEvents = false,
 ...
 * -----------------------------------------------------------------------------------------------*/
        ...
        const $f1701beae083dbae$export$602eac185826482c = /*#__PURE__*/ (0, external_React_namespaceObject.forwardRef)((props, forwardedRef) => {
            ...
            const {
                container: container = globalThis === null || globalThis === void 0 ? void 0 : (_globalThis$document = globalThis.document) === null || _globalThis$document === void 0 ? void 0 : _globalThis$document.body,
                ...portalProps
            } = props;
...
// eslint-disable-next-line @typescript-eslint/ban-types
        ...
        var RemoveScroll = external_React_namespaceObject.forwardRef(function (props, parentRef) {
            ...
            var forwardProps = props.forwardProps, children = props.children, className = props.className,
                removeScrollBar = props.removeScrollBar, enabled = props.enabled, shards = props.shards,
                sideCar = props.sideCar, noIsolation = props.noIsolation, inert = props.inert,
                allowPinchZoom = props.allowPinchZoom, _b = props.as, Container = _b === void 0 ? 'div' : _b,
            ...
            return (external_React_namespaceObject.createElement(external_React_namespaceObject.Fragment, null,
                enabled && (external_React_namespaceObject.createElement(SideCar, {
                    sideCar: effectCar,
...
// thus we are using style-singleton - only the first "yet correct" style will be applied.
        ...
        var RemoveScrollBar = function (props) {
            var noRelative = props.noRelative, noImportant = props.noImportant, _a = props.gapMode,
     ...
     */
        ...
        function RemoveScrollSideCar (props) {
            ...
            var Style = external_React_namespaceObject.useState(function () {
        ...
        var ReactRemoveScroll = external_React_namespaceObject.forwardRef(function (props, ref) {
            return (external_React_namespaceObject.createElement(RemoveScroll, __assign({}, props, {
                ref: ref,
                sideCar: sidecar
            })));
        });
...
// EXTERNAL MODULE: ./node_modules/command-score/index.js
        ...
        var ue = '[cmdk-list-sizer=""]', M = '[cmdk-group=""]', N = '[cmdk-group-items=""]',
            de = '[cmdk-group-heading=""]', ee = '[cmdk-item=""]', Z = `${ee}:not([aria-disabled="true"])`,
            z = 'cmdk-item-select', S = 'data-value', fe = (n, a) => command_score(n, a),
            te = external_React_namespaceObject.createContext(void 0),
            k = () => external_React_namespaceObject.useContext(te),
            re = external_React_namespaceObject.createContext(void 0),
            U = () => external_React_namespaceObject.useContext(re),
            ...
            oe = external_React_namespaceObject.forwardRef((n, a) => {
                let r = external_React_namespaceObject.useRef(null),
                    ...
                    u = x(() => new Set), l = x(() => new Map), p = x(() => new Map), f = x(() => new Set), d = ae(n), {
                        ...
                        shouldFilter: ie,
                        ...D
                    } = n, F = external_React_namespaceObject.useId(), g = external_React_namespaceObject.useId(),
                    A = external_React_namespaceObject.useId(), y = ye();
                L(() => {
                    if (R !== void 0) {
                ...
                let h = external_React_namespaceObject.useMemo(() => ({
                    subscribe: e => (f.current.add(e), () => f.current.delete(e)),
                    snapshot: () => o.current,
                    setState: (e, c, i) => {
                        var s, m, b;
                        if (!Object.is(o.current[e], c)) {
                            if (o.current[e] = c, e === 'search') j(), G(), y(1, V); else if (e === 'value') if (((s = d.current) == null ? void 0 : s.value) !== void 0) {
                ...
                }), []), K = external_React_namespaceObject.useMemo(() => ({
                    value: (e, c) => {
                        c !== p.current.get(e) && (p.current.set(e, c), o.current.filtered.items.set(e, B(c)), y(2, () => {
                            G(), h.emit();
                        }));
                    },
                    item: (e, c) => (u.current.add(e), c && (l.current.has(c) ? l.current.get(c).add(e) : l.current.set(c, new Set([e]))), y(3, () => {
                ...
                function j () {
                    ...
                    for (let [c, i] of l.current) for (let s of i) if (o.current.filtered.items.get(s) > 0) {
                ...
                return external_React_namespaceObject.createElement('div', {
                    ...
                    onKeyDown: e => {
                        var c;
                        if ((c = D.onKeyDown) == null || c.call(D, e), !e.defaultPrevented) switch (e.key) {
                            case'n':
                            case'j': {
                                e.ctrlKey && X(e);
                                break;
                ...
                }, external_React_namespaceObject.createElement('label', {
                    'cmdk-label': '',
                    htmlFor: K.inputId,
                    id: K.labelId,
                    style: xe
                ...
                L(() => l.item(r, u), []);
                let f = se(r, o, [n.value, n.children, o]), d = U(), v = T(g => g.value && g.value === f.current),
                    E = T(g => l.filter() === !1 ? !0 : g.search ? g.filtered.items.get(r) > 0 : !0);
                ...
                return external_React_namespaceObject.createElement('div', {
                    ...
                    role: 'presentation',
                    hidden: E ? void 0 : !0
                }, r && external_React_namespaceObject.createElement('div', {
                    ref: f,
                    'cmdk-group-heading': '',
                    'aria-hidden': !0,
                    id: d
                ...
                }, []), external_React_namespaceObject.createElement('div', {
                    ref: H([u, a]), ...o,
                    'cmdk-list': '',
                    role: 'listbox',
                ...
                return external_React_namespaceObject.useEffect(() => {
                    r.current = !1;
                }, []), r.current || !o ? null : external_React_namespaceObject.createElement('div', {
                    ref: a, ...n,
                    'cmdk-empty': '',
                    role: 'presentation'
                });
            ...
            return L(() => {
                ...
                let l = (() => {
                    ...
                    for (let d of r) {
                        ...
                        if (typeof d == 'object' && 'current' in d && d.current) return (f = d.current.textContent) == null ? void 0 : f.trim().toLowerCase();
                    }
                })();
        ...
        var ye = () => {
            let [n, a] = external_React_namespaceObject.useState(), r = x(() => new Map);
            return L(() => {
