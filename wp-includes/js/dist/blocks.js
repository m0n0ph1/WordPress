...
// NAMESPACE OBJECT: ./node_modules/@wordpress/blocks/build-module/store/actions.js
        ...
        var a11y_o = function (o) {
            var t = o / 255;
            return t < .04045 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);
        }, a11y_t = function (t) {
            return .2126 * a11y_o(t.r) + .7152 * a11y_o(t.g) + .0722 * a11y_o(t.b);
        };/* harmony default export */
        function a11y(o) {
            o.prototype.luminance = function () {
                return o = a11y_t(this.rgba), void 0 === (r = 2) && (r = 0), void 0 === n && (n = Math.pow(10, r)), Math.round(n * o) / n + 0;
                var o, r, n;
            }, o.prototype.contrast = function (r) {
                void 0 === r && (r = '#FFF');
                var n, a, i, e, v, u, d, c = r instanceof o ? r : new o(r);
                return e = this.rgba, v = c.toRgb(), u = a11y_t(e), d = a11y_t(v), n = u > d ? (u + .05) / (d + .05) : (d + .05) / (u + .05), void 0 === (a = 2) && (a = 0), void 0 === i && (i = Math.pow(10, a)), Math.floor(i * n) / i + 0;
...
// - Transformed: `true`
   ...
   */
        ...
        /* harmony default export */
        const shortcode_converter = (segmentHTMLToShortcodeBlock);
