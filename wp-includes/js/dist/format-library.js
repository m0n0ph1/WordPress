...
// ESM COMPAT FLAG
    ...
    /* harmony default export */
    const keyboard_return = (keyboardReturn);
    ...
    /* harmony default export */
    const format_italic = (formatItalic);
...
// Weakly referenced map allows unused ids to be garbage collected.
    ...
    /* harmony default export */
    const use_link_instance_key = (useLinkInstanceKey);
    ...
    /* harmony default export */
    const inline = ((0, external_wp_components_namespaceObject.withSpokenMessages)(InlineLinkUI));
    ...
    /* harmony default export */
    const format_strikethrough = (formatStrikethrough);
    ...
    /* harmony default export */
    const library_subscript = (subscript);
    ...
    /* harmony default export */
    const library_superscript = (superscript);
    ...
    /* harmony default export */
    const library_button = (button_button);
    ...
    /* harmony default export */
    const library_language = (language);
    ...
    /* harmony default export */
    const default_formats = ([bold, code_code, image_image, italic, build_module_link_link, strikethrough, underline, text_color_textColor, subscript_subscript, superscript_superscript, keyboard, unknown, language_language]);
