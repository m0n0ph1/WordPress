...
// Remove all non-word characters.
    ...
    /* harmony default export */
    const block_ratings = (BlockRatings);
    ...
    /* harmony default export */
    const downloadable_block_icon = (DownloadableBlockIcon);
    ...
    /* harmony default export */
    const downloadable_block_notice = (DownloadableBlockNotice);
    ...
    /* harmony default export */
    const downloadable_block_list_item = (DownloadableBlockListItem);
    ...
    /* harmony default export */
    const downloadable_blocks_list = (DownloadableBlocksList);
    ...
    /* harmony default export */
    const inserter_panel = (DownloadableBlocksInserterPanel);
    ...
    /* harmony default export */
    const no_results = (DownloadableBlocksNoResults);
    ...
    /* harmony default export */
    const downloadable_blocks_panel = ((0, external_wp_compose_namespaceObject.compose)([(0, external_wp_data_namespaceObject.withSelect)((select, {
        filterValue,
        rootClientId = null
    }) => {
        const {
    ...
    /* harmony default export */
    const inserter_menu_downloadable_blocks_panel = (InserterMenuDownloadableBlocksPanel);
...
// because it would include the wp-edit-post in all pages loading the block-directory script.
    ...
    const getInstallMissing = OriginalComponent => props => {
        ...
        return (0, external_wp_element_namespaceObject.createElement)(ModifiedWarning, {
            ...props,
            originalBlock: block
        });
    };
    ...
    /* harmony default export */
    const get_install_missing = (getInstallMissing);
