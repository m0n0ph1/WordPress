<?php
    ...
    final class WP_Recovery_Mode_Cookie_Service
    {
         ...
         *
         * We cannot use `wp_hash()` because it is defined in `pluggable.php` which is not loaded until after plugins
         * are loaded, which is too late to verify the recovery mode cookie.
         *
         * This tries to use the `AUTH` salts first, but if they aren't valid specific salts will be generated and
         * stored.
         *
