<?php
    ...
    function render_block_core_avatar($attributes, $content, $block)
    {
        ...
        if(! isset($block->context['commentId']))
        {
            ...
            $avatar_block = get_avatar($author_id, $size, '', $alt, [
        ...
        $avatar_block = get_avatar($comment, $size, '', $alt, [
            'extra_attr' => $image_styles,
            'class' => $image_classes,
        ]);
    ...
    function get_block_core_avatar_border_attributes($attributes)
    {
        ...
        {
            $border = _wp_array_get($attributes, ['style', 'border', $side], null);
            $border_styles[$side] = [
    ...
    {
        register_block_type_from_metadata(__DIR__.'/avatar', [
