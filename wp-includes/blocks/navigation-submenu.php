<?php
    ...
    function render_block_core_navigation_submenu($attributes, $content, $block)
    {
        ...
        $wrapper_attributes = get_block_wrapper_attributes([
                                                               'class' => $css_classes.' wp-block-navigation-item'.($has_submenu ? ' has-child' : '').($open_on_click ? ' open-on-click' : '').($open_on_hover_and_click ? ' open-on-hover-click' : '').($is_active ? ' current-menu-item' : ''),
        ...
        $aria_label = sprintf(/* translators: Accessibility text. %s: Parent page title. */ __('%s submenu'), wp_strip_all_tags($label));
