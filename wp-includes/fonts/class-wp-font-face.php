    ...
    class WP_Font_Face
    {
        ...
        private function validate_font_face_declarations(array $font_face)
        {
            ...
            if(empty($font_face['font-family']) || ! is_string($font_face['font-family']))
            {
                ...
                _doing_it_wrong(__METHOD__, __('Font font-family must be a non-empty string.'), '6.4.0');
            ...
            {
                // @todo replace with `wp_trigger_error()`.
                _doing_it_wrong(__METHOD__, __('Font src must be a non-empty string or an array of strings.'), '6.4.0');
            ...
            foreach((array) $font_face['src'] as $src)
            {
                ...
                {
                    // @todo replace with `wp_trigger_error()`.
                    _doing_it_wrong(__METHOD__, __('Each font src must be a non-empty string.'), '6.4.0');
            ...
            {
                // @todo replace with `wp_trigger_error()`.
                _doing_it_wrong(__METHOD__, __('Font font-weight must be a properly formatted string or integer.'), '6.4.0');
        ...
        private function build_font_face_css(array $font_face)
        {
             ...
             */
            if(str_contains($font_face['font-family'], ' ') && ! str_contains($font_face['font-family'], '"') && ! str_contains($font_face['font-family'], "'"))
            {
