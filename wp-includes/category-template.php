<?php
     ...
     *                                           Optional. Array or string of arguments to generate a categories drop-down element. See
     *                                           WP_Term_Query::__construct() for information on additional accepted arguments.
     *
     ...
     *                                               also be excluded; see `$exclude_tree`. See get_terms(). Default empty string.
     ...
     *                                               will be output as an unordered list. If left empty or another
     *                                               value, categories will be output separated by `<br>` tags. Default 'list'.
