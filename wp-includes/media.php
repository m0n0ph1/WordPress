<?php
     ...
     * element should have both `loading="lazy"` and `fetchpriority="high"`, so the function will trigger a warning in
     * case both attributes are present with those values.
     *
     * @param string    $tag_name The tag name.
