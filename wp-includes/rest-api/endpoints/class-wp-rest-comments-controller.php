<?php
    ...
    class WP_REST_Comments_Controller extends WP_REST_Controller
    {
        ...
        public function get_items_permissions_check($request)
        {
            if(! empty($request['post']))
            {
                foreach((array) $request['post'] as $post_id)
                {
                    ...
                    {
                        return new WP_Error('rest_cannot_read_post', __('Sorry, you are not allowed to read the post for this comment.'), ['status' => rest_authorization_required_code()]);
                    }
                    elseif(0 === $post_id && ! current_user_can('moderate_comments'))
                    {
                        return new WP_Error('rest_cannot_read', __('Sorry, you are not allowed to read comments without a post.'), ['status' => rest_authorization_required_code()]);
                    }
                }
            }
            ...
            {
                return new WP_Error('rest_forbidden_context', __('Sorry, you are not allowed to edit comments.'), ['status' => rest_authorization_required_code()]);
            }
            ...
            if(! current_user_can('edit_posts'))
            {
                ...
                {
                    return new WP_Error('rest_forbidden_param', /* translators: %s: List of forbidden parameters. */ sprintf(__('Query parameter not permitted: %s'), implode(', ', $forbidden_params)), ['status' => rest_authorization_required_code()]);
                }
            }
        ...
        public function get_item_permissions_check($request)
        {
            ...
            if(! $this->check_read_permission($comment, $request))
            {
                return new WP_Error('rest_cannot_read', __('Sorry, you are not allowed to read this comment.'), ['status' => rest_authorization_required_code()]);
            }
        ...
        public function create_item_permissions_check($request)
        {
            ...
            {
                return new WP_Error('rest_comment_invalid_author', /* translators: %s: Request parameter. */ sprintf(__("Sorry, you are not allowed to edit '%s' for comments."), 'author'), ['status' => rest_authorization_required_code()]);
            }
            ...
            if(isset($request['author_ip']) && ! current_user_can('moderate_comments'))
            {
                ...
                {
                    return new WP_Error('rest_comment_invalid_author_ip', /* translators: %s: Request parameter. */ sprintf(__("Sorry, you are not allowed to edit '%s' for comments."), 'author_ip'), ['status' => rest_authorization_required_code()]);
                }
            }

            if(isset($request['status']) && ! current_user_can('moderate_comments'))
            {
                return new WP_Error('rest_comment_invalid_status', /* translators: %s: Request parameter. */ sprintf(__("Sorry, you are not allowed to edit '%s' for comments."), 'status'), ['status' => rest_authorization_required_code()]);
            }

            if(empty($request['post']))
            {
                return new WP_Error('rest_comment_invalid_post_id', __('Sorry, you are not allowed to create this comment without a post.'), ['status' => 403]);
            }
            ...
            {
                return new WP_Error('rest_comment_draft_post', __('Sorry, you are not allowed to create a comment on this post.'), ['status' => 403]);
            }

            if('trash' === $post->post_status)
            {
                return new WP_Error('rest_comment_trash_post', __('Sorry, you are not allowed to create a comment on this post.'), ['status' => 403]);
            }
            ...
            {
                return new WP_Error('rest_comment_closed', __('Sorry, comments are closed for this item.'), ['status' => 403]);
            }
        ...
        public function create_item($request)
        {
            ...
            {
                return new WP_Error('rest_invalid_comment_type', __('Cannot create a comment with that type.'), ['status' => 400]);
            }
            ...
            if(get_option('require_name_email'))
            {
                ...
                {
                    return new WP_Error('rest_comment_author_data_required', __('Creating a comment requires valid author name and email values.'), ['status' => 400]);
                }
            }
            ...
            if(is_wp_error($check_comment_lengths))
            {
                ...
                return new WP_Error($error_code, __('Comment field exceeds maximum length allowed.'), ['status' => 400]);
            }
		 ...
		 */
            ...
            if(isset($request['author']))
            {
                ...
                {
                    return new WP_Error('rest_comment_author_invalid', __('Invalid comment author ID.'), ['status' => 400]);
                }
            }
        ...
        public function update_item_permissions_check($request)
        {
            ...
            {
                return new WP_Error('rest_cannot_edit', __('Sorry, you are not allowed to edit this comment.'), ['status' => rest_authorization_required_code()]);
            }
        ...
        public function update_item($request)
        {
            ...
            {
                return new WP_Error('rest_comment_invalid_type', __('Sorry, you are not allowed to change the comment type.'), ['status' => 404]);
            }
            ...
            if(empty($prepared_args) && isset($request['status']))
            {
                ...
                if(! $change)
                {
                    return new WP_Error('rest_comment_failed_edit', __('Updating comment status failed.'), ['status' => 500]);
                }
            }
        ...
        public function delete_item_permissions_check($request)
        {
            ...
            if(! $this->check_edit_permission($comment))
            {
                return new WP_Error('rest_cannot_delete', __('Sorry, you are not allowed to delete this comment.'), ['status' => rest_authorization_required_code()]);
            }
        ...
        public function delete_item($request)
        {
            ...
            else
            {
                ...
                if(! $supports_trash)
                {
                    return new WP_Error('rest_trash_not_supported', /* translators: %s: force=true */ sprintf(__("The comment does not support trashing. Set '%s' to delete."), 'force=true'), ['status' => 501]);
                }

                if('trash' === $comment->comment_approved)
                {
                    return new WP_Error('rest_already_trashed', __('The comment has already been trashed.'), ['status' => 410]);
                }
