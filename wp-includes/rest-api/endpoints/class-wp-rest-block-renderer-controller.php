    ...
    class WP_REST_Block_Renderer_Controller extends WP_REST_Controller
    {
        ...
        public function get_item_permissions_check($request)
        {
            ...
            if($post_id > 0)
            {
                ...
                {
                    return new WP_Error('block_cannot_read', __('Sorry, you are not allowed to read blocks of this post.'), [
            ...
            else
            {
                ...
                {
                    return new WP_Error('block_cannot_read', __('Sorry, you are not allowed to read blocks as this user.'), [
                        'status' => rest_authorization_required_code(),
                    ]);
                }
            }
