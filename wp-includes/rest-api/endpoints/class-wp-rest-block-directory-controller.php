<?php
    ...
    class WP_REST_Block_Directory_Controller extends WP_REST_Controller
    {
        ...
        public function get_items_permissions_check($request)
        {
            ...
            {
                return new WP_Error('rest_block_directory_cannot_view', __('Sorry, you are not allowed to browse the block directory.'), ['status' => rest_authorization_required_code()]);
            }
        ...
        public function prepare_item_for_response($item, $request)
        {
            ...
            $block = [
                ...
                'humanized_updated' => sprintf(/* translators: %s: Human-readable time difference. */ __('%s ago'), human_time_diff(strtotime($plugin['last_updated']))),
            ];
