<?php
     ...
     * an object subtype is omitted, the meta key will be registered for the entire object type, however it can be
     * partly overridden in case a more specific meta key of the same name exists for the same object type and a
     * subtype.
     *
     * If an object type does not support any subtypes, such as users or comments, you should commonly call this
     * function without passing a subtype.
     *
     * @param string       $object_type        Type of object metadata is for. Accepts 'post', 'comment', 'term', 'user',
     *                                         or any other object type with an associated meta table.
     ...
     *                                         the meta key will be registered on the entire object type. Default
     *                                         empty.
     ...
     *                                         When using a non-single meta key, the default value is for the first
     *                                         entry. In other words, when calling get_metadata() with `$single` set to `false`, the default value given
     *                                         here will be wrapped in an array.
     ...
     *                                         should be accessible via the REST API. A custom post type must also
     *                                         declare support for custom fields for registered meta to be accessible via REST. When registering complex
     *                                         meta values this argument may optionally be an array with 'schema' or 'prepare_callback' keys instead of a
     *                                         boolean.
     *                                         }
     *
