<?php
    ...
    class WP_User_Query
    {
         ...
         *                                                to be included in results. Note that this is an inclusive
         ...
         * @type string|string[] $capability              An array or a comma-separated list of capability names that users must
         *                                                match to be included in results. Note that this is an inclusive list: users must match *each*
         *                                                capability. Does NOT work for capabilities not in the database or filtered via {@see 'map_meta_cap'}.
         *                                                Default empty.
         * @type string[]        $capability__in          An array of capability names. Matched users must have at least one of these
         *                                                capabilities.
         *                                                Does NOT work for capabilities not in the database or
         *                                                filtered via {@see 'map_meta_cap'}. Default empty array.
         * @type string[]        $capability__not_in      An array of capability names to exclude. Users matching one or more of
         *                                                these capabilities will not be included in results. Does NOT work for capabilities not in the database
         *                                                or filtered via {@see 'map_meta_cap'}. Default empty array.
         ...
         *                                                When `$search_columns` is left empty, it tries to determine
         *                                                which column to search in based on search string. Default empty.
         ...
         *                                                an array of values, or a multi-dimensional array with fields
         *                                                as keys and orders ('ASC' or 'DESC') as values. Accepted values are:
         *                                                - 'ID'
         ...
         *                                                passed as part of an `$orderby` array take precedence over
         *                                                this parameter. Accepts 'ASC', 'DESC'. Default 'ASC'.
         ...
         *                                                published posts in those post types. `true` is an alias for
         ...
         *                                                nicenames will not be included in results. Default empty
         *                                                array.
         ...
         *                                                permit an array or comma-separated list of values. The 'number' parameter was updated to
         *                                                support
         ...
         * @param bool     $wild    Whether to allow wildcard searches. Default is false for Network Admin, true for single
         *                          site. Single site allows leading and trailing wildcards, Network Admin only trailing.
         *
         * @return string
         * @since 3.1.0
         *
