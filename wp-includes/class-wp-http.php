<?php
    ...
    class WP_Http
    {
         ...
         *
         * @return string An Absolute URL, in a failure condition where the URL cannot be parsed, the relative URL will
         *     be returned.
         * @since 3.4.0
         *
         */
         ...
         *                                             and processing returned to the calling code immediately, the
         *                                             caller will know if the request succeeded or failed, but will not receive any response from the remote
         *                                             server. Default true.
         ...
         *                                             given, it will be dropped it in the WP temp dir and its name
         *                                             will
