    ...
    class WP_Customize_Media_Control extends WP_Customize_Control
    {
        ...
        public function to_json()
        {
            ...
            if(is_object($this->setting))
            {
                if($this->setting->default)
                {
                    ...
                    $type = in_array($ext, ['jpg', 'png', 'gif', 'bmp', 'webp'], true) ? 'image' : 'document';
        ...
        public function content_template()
        {
            ...
            <div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
                <div class="thumbnail thumbnail-{{ data.attachment.type }}">
                    ...
                    <img class="attachment-thumb"
                         src="{{ data.attachment.sizes.medium.url }}"
                         draggable="false"
                         alt=""/>
                ...
                <div class="actions">
                    ...
                    <button type="button" class="button upload-button control-focus" {{{ describedByAttr }}}>{{
            ...
            <div class="attachment-media-view">
                <# if ( data.canUpload ) { #>
                <button type="button" class="upload-button button-add-media" {{{ describedByAttr }}}>{{
