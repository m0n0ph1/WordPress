<?php
    ...
    class WP_Customize_Nav_Menu_Item_Setting extends WP_Customize_Setting
    {
         ...
         *
         * @return array|false|null|WP_Error Null or WP_Error if an input isn't valid. False if it is marked for
         *     deletion. Otherwise the sanitized value.
         * @since 4.3.0
        ...
        protected function update($value)
        {
            ...
            else
            {
                ...
                $r = wp_update_nav_menu_item($value['nav_menu_term_id'], $is_placeholder ? 0 : $this->post_id, wp_slash($menu_item_data));
                if(is_wp_error($r))
                {
                    $this->update_status = 'error';
                    $this->update_error = $r;
