<?php
    ...
    class WP_Customize_Partial
    {
         ...
         *                                                            rendering. If not supplied, it will default to the ID of the first
         *                                                            setting.
         * @type string                          $capability          Capability required to edit this partial.
         *                                                            Normally this is empty and the capability is derived from the
         *                                                            capabilities of the associated `$settings`.
         * @type callable                        $render_callback     Render callback.
         *                                                            Callback is called with one argument, the instance of
         *                                                            WP_Customize_Partial. The callback can either echo the partial or return the partial as a string, or
         ...
         *                                                            A partial render is considered a failure if the render_callback
         *                                                            returns false.
         *                                                            }
         * @since 4.5.0
         *
