<?php
     ...
     *                                  $nooped_plural contains a text domain passed to _n_noop() or _nx_noop(), it will override this value.
     *                                  Default 'default'.
     *
    ...
    {
        /** @var WP_Textdomain_Registry $wp_textdomain_registry */ global $l10n, $l10n_unloaded, $wp_textdomain_registry;
    ...
    {
        /** @var WP_Textdomain_Registry $wp_textdomain_registry */ global $wp_textdomain_registry;
        /**
    ...
    {
        /** @var WP_Textdomain_Registry $wp_textdomain_registry */ global $l10n_unloaded, $wp_textdomain_registry;
        $l10n_unloaded = (array) $l10n_unloaded;
