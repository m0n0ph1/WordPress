<?php
    ...
    class SMTP
    {
        ...
        public function client_send($data, $command = '')
        {
            ...
            if(
                self::DEBUG_LOWLEVEL > $this->do_debug && in_array($command, [
                    'User & Password',
                    'Username',
                    'Password'
                ],                                                 true)
        ...
        public function authenticate(
            $username, $password, $authtype = null, $OAuth = null
        ) {
            if(! $this->server_caps)
            {
         ...
         *
         * @param string|callable $method The name of the mechanism to use for debugging output, or a callable to
         *                                handle it
         */
