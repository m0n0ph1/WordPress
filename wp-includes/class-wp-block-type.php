<?php
    ...
    class WP_Block_Type
    {
         ...
         *                                                   block types at any position of the ancestor's block
         *                                                   subtree.
         ...
         *                                                   Deprecated the `editor_script`, `script`, `view_script`, `editor_style`, and `style`
         *                                                   properties.
         ...
         *
         * @return string|string[]|null|void The value read from the new property if the first item in the array
         *     provided, null when value not found, or void when unknown property name provided.
         * @since 6.1.0
         *
         */
