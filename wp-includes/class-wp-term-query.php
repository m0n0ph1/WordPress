<?php
    ...
    class WP_Term_Query
    {
         ...
         *                                                      - Term fields ('name', 'slug', 'term_group', 'term_id',
         *                                                      'id',
         *                                                      'description', 'parent', 'term_order'). Unless
         *                                                      `$object_ids` is not empty, 'term_order' is treated the same as 'term_id'.
         *                                                      - 'count' to use the number of objects associated with the
         *                                                      term.
         ...
         *                                                      non-empty, `$exclude_tree` is ignored. Default empty
         *                                                      array.
         * @type int|string      $number                        Maximum number of terms to return. Accepts ''|0 (all) or any
         *                                                      positive number. Default ''|0 (all). Note that `$number`
         *                                                      may not return accurate results when coupled with `$object_ids`. See #41796 for details.
         ...
         *                                                      - 'id=>parent' Returns an associative array of parent term
         *                                                      IDs, keyed by term ID (`int[]`).
         ...
         *                                                      This parameter has no effect on non-hierarchical
         *                                                      taxonomies. Default false.
