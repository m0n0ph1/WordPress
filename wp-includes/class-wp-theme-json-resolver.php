<?php
    ...
    class WP_Theme_JSON_Resolver
    {
         ...
         *
         * Unlike the getters
         * {@link https://developer.wordpress.org/reference/classes/wp_theme_json_resolver/get_core_data/
         * get_core_data},
         ...
         *
         * @param string $origin Optional. To what level should we merge data: 'default', 'blocks', 'theme' or
         *                       'custom'.
        ...
        public static function get_block_data()
        {
            ...
            foreach($blocks as $block_name => $block_type)
            {
                ...
                if(
                    isset($block_type->supports['spacing']['blockGap']['__experimentalDefault']) && null === _wp_array_get($config, [
                        'styles',
                        'blocks',
                        $block_name,
                        'spacing',
        ...
        public static function get_user_data()
        {
            ...
            if(array_key_exists('post_content', $user_cpt))
            {
                 ...
                 */
                if(is_array($decoded_data) && isset($decoded_data['isGlobalStylesUserThemeJSON']) && $decoded_data['isGlobalStylesUserThemeJSON'])
                {
        ...
        public static function get_user_data_from_wp_global_styles(
            $theme, $create_post = false, $post_status_filter = ['publish']
        ) {
        ...
        public static function get_style_variations()
        {
            ...
            {
                $decoded_file = wp_json_file_decode($path, ['associative' => true]);
                if(is_array($decoded_file))
                {
