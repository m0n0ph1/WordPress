<?php
     ...
     * This adds a `wp_theme_preview` URL parameter to API requests from the Site Editor, so they also respond as if
     * the theme is set to the value of the parameter.
     *
     * @since 6.3.0
     */
