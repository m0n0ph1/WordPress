<?php
    ...
    class WP_Embed
    {
         ...
         *                           Lower numbers correspond with earlier testing, and handlers with the same priority
         *                           are tested in the order in which they were added to the action. Default 10.
         */
