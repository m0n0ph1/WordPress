<?php
    ...
    function _wp_add_block_level_presets_class($block_content, $block)
    {
        ...
        $block_settings = _wp_array_get($block, ['attrs', 'settings'], null);
    ...
    function _wp_add_block_level_preset_styles($pre_render, $block)
    {
        ...
        $styles .= $theme_json_object->get_stylesheet(['variables'], null, [
            'root_selector' => $variables_root_selector,
            'scope' => $class_name,
        ]);

        // include preset css classes on the the stylesheet.
        $styles .= $theme_json_object->get_stylesheet(['presets'], null, [
