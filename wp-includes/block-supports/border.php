<?php
    ...
    function wp_apply_border_support($block_type, $block_attributes)
    {
        ...
        if($has_border_color_support || $has_border_width_support)
        {
            ...
            {
                $border = _wp_array_get($block_attributes, ['style', 'border', $side], null);
                $border_side_values = [
    ...
    function wp_has_border_feature_support($block_type, $feature, $default_value = false)
    {
        ...
        if(property_exists($block_type, 'supports') && (true === _wp_array_get($block_type->supports, ['__experimentalBorder'], $default_value)))
        {
            return true;
        }
...
// Register the block support.
    WP_Block_Supports::get_instance()->register('border', [
