    ...
    function wp_print_media_templates()
    {
        ...
        <script type="text/html" id="tmpl-media-modal">
            <div tabindex="0" class="<?php echo $class; ?>" role="dialog" aria-labelledby="media-frame-title">
                ...
                <button type="button"
                        class="media-modal-close"><span class="media-modal-icon"><span class="screen-reader-text">
					<?php
                        /* translators: Hidden accessibility text. */
                        _e('Close dialog');
                    ?>
            ...
            <div class="uploader-inline-content {{ messageClass }}">
                ...
                <?php if(! _device_can_upload()) : ?>
                    <div class="upload-ui">
                        ...
                        <p>
                            <?php
                                printf(/* translators: %s: https://apps.wordpress.org/ */ __('The web browser on your device cannot be used to upload files. You may be able to use the <a href="%s">native app for your device</a> instead.'), 'https://apps.wordpress.org/');
                            ?>
                        </p>
                    </div>
                ...
                <?php else : ?>
                    <div class="upload-ui">
                        ...
                        <button type="button"
                                ...
                                aria-labelledby="post-upload-info"><?php _e('Select Files'); ?></button>
                    </div>
                    ...
                    <div class="post-upload-ui" id="post-upload-info">
                        ...
                        <p class="max-upload-size">
                            <?php
                                printf(/* translators: %s: Maximum allowed file size. */ __('Maximum upload file size: %s.'), esc_html(size_format($max_upload_size)));
                            ?>
                        </p>
        ...
        <script type="text/html" id="tmpl-media-library-view-switcher">
            ...
            <a href="<?php echo esc_url(add_query_arg('mode', 'grid', admin_url('upload.php'))); ?>"
        ...
        <script type="text/html" id="tmpl-edit-attachment-frame">
            <div class="edit-media-header">
                ...
                <# if ( ! data.hasPrevious ) { #> disabled<# }
                #>><span class="screen-reader-text"><?php /* translators: Hidden accessibility text. */
                        _e('Edit previous media item'); ?></span></button>
                <button class="right dashicons"
                <# if ( ! data.hasNext ) { #> disabled<# }
                #>><span class="screen-reader-text"><?php /* translators: Hidden accessibility text. */
                        _e('Edit next media item'); ?></span></button>
                <button type="button" class="media-modal-close">
                    <span class="media-modal-icon"><span class="screen-reader-text"><?php _e('Close dialog'); ?></span></span>
                </button>
            </div>
        ...
        <script type="text/html" id="tmpl-attachment-details-two-column">
			...
			<span class="settings-save-status" role="status">
                ...
                <div class="settings">
					...
					<input type="text"
                           id="attachment-details-two-column-<?php echo esc_attr($key); ?>"
        ...
        <script type="text/html" id="tmpl-attachment">
            <div class="attachment-preview js--select-attachment type-{{ data.type }} subtype-{{ data.subtype }} {{ data.orientation }}">
                ...
                <button type="button"
                        class="button-link attachment-close media-modal-icon"><span class="screen-reader-text">
					<?php
                        /* translators: Hidden accessibility text. */
                        _e('Remove');
                    ?>
            ...
            <button type="button" class="check" tabindex="-1">
                <span class="media-modal-icon"></span><span class="screen-reader-text">
				<?php
                    /* translators: Hidden accessibility text. */
                    _e('Deselect');
                ?>
        ...
        <script type="text/html" id="tmpl-attachment-details">
            ...
            <div class="attachment-info">
                ...
                <div class="details">
                    ...
                    <a class="edit-attachment"
                       ...
                       target="_blank"><?php _e('Edit Image'); ?></a>
                    <# } #>
                    <# } #>
			...
			<input type="text"
                   id="attachment-details-<?php echo esc_attr($key); ?>"
                   value="{{ data.<?php echo $key; ?> || data.meta.<?php echo $key; ?> || '' }}"/>
		</span>
                <?php endforeach; ?>
            <# } #>
			...
			<div class="copy-to-clipboard-container">
				<button type="button"
                        class="button button-small copy-attachment-url"
                        data-clipboard-target="#attachment-details-copy-link"><?php _e('Copy URL to clipboard'); ?></button>
				<span class="success hidden" aria-hidden="true"><?php _e('Copied!'); ?></span>
			</div>
		</span>
        </script>
        ...
        <script type="text/html" id="tmpl-gallery-settings">
			...
			<label for="gallery-settings-random-order"
                   class="checkbox-label-inline"><?php _e('Random Order'); ?></label>
		</span>
        ...
        <script type="text/html" id="tmpl-embed-image-settings">
			...
			<textarea id="embed-image-settings-alt-text"
                      data-setting="alt"
            ...
            <div class="media-embed">
                <div class="embed-media-settings">
					...
					<span class="setting alt-text has-description">
						...
						<textarea id="image-details-alt-text"
                                  data-setting="alt"
                        ...
                        <div class="advanced-section">
                            <h2>
                                <button type="button"
                                        class="button-link advanced-toggle"><?php _e('Advanced Options'); ?></button>
                            </h2>
                            <div class="advanced-settings hidden">
                                <div class="advanced-image">
								<span class="setting title-text">
									<label for="image-details-title-attribute"
                                           class="name"><?php _e('Image Title Attribute'); ?></label>
									<input type="text"
									...
									<label for="image-details-css-class"
                                           class="name"><?php _e('Image CSS Class'); ?></label>
									<input type="text"
								...
								<span class="setting link-target">
									<input type="checkbox"
                                           id="image-details-link-target"
                                           data-setting="linkTargetBlank"
                                           value="_blank" <# if ( data.model.linkTargetBlank ) { #>checked="checked"<# } #>>
									<label for="image-details-link-target"
                                           class="checkbox-label"><?php _e('Open link in a new tab'); ?></label>
								</span>
									...
									<label for="image-details-link-css-class"
                                           class="name"><?php _e('Link CSS Class'); ?></label>
									<input type="text"
                    ...
                    <div class="column-image">
                        <div class="image">
                            ...
                            <div class="actions">
                                <input type="button"
                                       class="edit-attachment button"
                                       value="<?php esc_attr_e('Edit Original'); ?>"/>
                                <input type="button"
                                       class="replace-attachment button"
                                       value="<?php esc_attr_e('Replace'); ?>"/>
                            </div>
                            <# } #>
                        </div>
                    </div>
        ...
        <script type="text/html" id="tmpl-audio-details">
            ...
            <div class="media-embed media-embed-details">
                <div class="embed-media-settings embed-audio-settings">
					...
					<button type="button"
                            class="button-link remove-setting"><?php _e('Remove audio source'); ?></button>
				</span>
                    <# } #>
                    <?php
                        foreach($audio_types as $type) :
                            ...
                            #>
                            <span class="setting">
					<label for="audio-details-<?php echo $type.'-source'; ?>"
                           class="name"><?php echo strtoupper($type); ?></label>
					<input type="text"
                           id="audio-details-<?php echo $type.'-source'; ?>"
                           readonly
                           data-setting="<?php echo $type; ?>"
                           value="{{ data.model.<?php echo $type; ?> }}"/>
					<button type="button"
                            class="button-link remove-setting"><?php _e('Remove audio source'); ?></button>
				</span>
                            <# } #>
            ...
            <div class="media-embed media-embed-details">
                <div class="embed-media-settings embed-video-settings">
					...
					<input type="text"
                           ...
                           value="{{ data.model.src }}"/>
					<button type="button"
                            class="button-link remove-setting"><?php _e('Remove video source'); ?></button>
				</span>
                        <# } #>
                        <?php
                            foreach($video_types as $type) :
                                ...
                                #>
                                <span class="setting">
					<label for="video-details-<?php echo $type.'-source'; ?>"
                           class="name"><?php echo strtoupper($type); ?></label>
					<input type="text"
                           id="video-details-<?php echo $type.'-source'; ?>"
                           readonly
                           data-setting="<?php echo $type; ?>"
                           value="{{ data.model.<?php echo $type; ?> }}"/>
					<button type="button"
					...
					<button type="button"
                            class="button-link remove-setting"><?php _e('Remove poster image'); ?></button>
				</span>
                    <# } #>
					...
					if ( ! _.isEmpty( data.model.content ) ) {
						...
						<label for="video-details-track-{{ index }}"
                               class="name"><?php _e('Tracks (subtitles, captions, descriptions, chapters, or metadata)'); ?></label>
						<input class="content-track"
                               type="text"
                               id="video-details-track-{{ index }}"
                               aria-describedby="video-details-track-desc-{{ index }}"
                               value="{{ track.outerHTML }}"/>
						<span class="description" id="video-details-track-desc-{{ index }}">
						<?php
                            printf(/* translators: 1: "srclang" HTML attribute, 2: "label" HTML attribute, 3: "kind" HTML attribute. */ __('The %1$s, %2$s, and %3$s values can be edited to set the video track language and kind.'), 'srclang', 'label', 'kind');
                        ?>
						</span>
						<button type="button"
                                class="button-link remove-setting remove-track"><?php _ex('Remove video track', 'media'); ?></button><br/>
						<# } ); #>
					<# } else { #>
        ...
        <script type="text/html" id="tmpl-crop-content">
            <img class="crop-image"
                 src="{{ data.url }}"
                 alt="<?php esc_attr_e('Image crop area preview. Requires mouse interaction.'); ?>"/>
            <div class="upload-errors"></div>
        </script>
