<?php
    ...
    class Cookie
    {
         ...
         * @param array|\WpOrg\Requests\Utility\CaseInsensitiveDictionary $attributes     Associative array of attribute
         *                                                                                data
         * @param array                                                   $flags          The flags for the cookie.
         *                                                                                Valid keys are `'creation'`,
         *                                                                                `'last-access'`,
         *                                                                                `'persistent'` and
         *                                                                                `'host-only'`.
         ...
         * @throws \WpOrg\Requests\Exception\InvalidArgument When the passed $attributes argument is not an array or
         ...
         * @throws \WpOrg\Requests\Exception\InvalidArgument When the passed $reference_time argument is not an integer
         *     or null.
         */
