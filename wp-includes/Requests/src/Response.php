<?php
    ...
    class Response
    {
         ...
         * @throws \WpOrg\Requests\Exception\Http On non-successful status code. Exception class corresponds to
         *     "Status" + code (e.g. {@see \WpOrg\Requests\Exception\Http\Status404})
         */
