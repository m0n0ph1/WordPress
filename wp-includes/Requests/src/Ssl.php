<?php
    ...
    final class Ssl
    {
         ...
         *
         * @return bool
         * @throws \WpOrg\Requests\Exception\InvalidArgument When the passed $host argument is not a string or a
         *     stringable object.
         * @throws \WpOrg\Requests\Exception\InvalidArgument When the passed $cert argument is not an array or array
         *     accessible.
         */
         ...
         * @throws \WpOrg\Requests\Exception\InvalidArgument When either of the passed arguments is not a string or a
         *     stringable object.
         */
